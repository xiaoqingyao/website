<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectItemReportAdd.aspx.cs" Inherits="FTD.Web.UI.aspx.ProjectM.ProjectItemReportAdd" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="middle" style="height: 30px;">&nbsp;<img src="../../images/BanKuaiJianTou.gif" />
                        <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;项目管理&nbsp;>>&nbsp;添加项目执行报告
                    </td>
            ...
            <table style="width: 100%" bgcolor="#999999" class="gridview_m" border="0" cellpadding="2" cellspacing="1">
                 ...
                 <tr>
                    <td style="width: 170px; height: 25px; background-color: #f9f9f7" align="right">项目：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                        <asp:DropDownList runat="server"> 
                            <asp:ListItem>山东潍坊抽水蓄能电站</asp:ListItem>
                            <asp:ListItem>泰开集团新能源箱变项目</asp:ListItem>
                            <asp:ListItem>舒驰新能源客车产业园项目</asp:ListItem>
                            <asp:ListItem>年产10万辆纯电动乘用车项目</asp:ListItem>
                        </asp:DropDownList>
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #f9f9f7" align="right">报告时间：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                        <asp:TextBox ID="txtProjectName" runat="server" Width="350px">2019-3-8</asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtProjectName"
                            ErrorMessage="*该项不可以为空"></asp:RequiredFieldValidator></td>
                </tr>
                 <tr>
                    <td style="width: 170px; height: 25px; background-color: #f9f9f7" align="right">报告人：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                        <asp:TextBox ID="TextBox6" runat="server" Width="350px">李新宇</asp:TextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="txtProjectName"
                            ErrorMessage="*该项不可以为空"></asp:RequiredFieldValidator></td>
                </tr>
                 <tr>
                    <td style="width: 170px; height: 25px; background-color: #f9f9f7" align="right">项目进度：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                         <asp:DropDownList runat="server"> 
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #f9f9f7" align="right">执行情况说明：
                    </td>
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #f9f9f7" align="right">负责人：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
