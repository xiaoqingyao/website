<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectList.aspx.cs" Inherits="FTD.Web.UI.aspx.ProjectM.ProjectList" %>
                ...
                <td>
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="3" HeaderText="建设年限从"></asp:BoundField>
                            <asp:BoundField DataField="4" HeaderText="到"></asp:BoundField>
                            <asp:BoundField DataField="5" HeaderText="区划(省)"></asp:BoundField>
                            <asp:BoundField DataField="6" HeaderText="区划(市)"></asp:BoundField>
                            <asp:BoundField DataField="7" HeaderText="区划(区县)"></asp:BoundField>
                            <asp:BoundField DataField="8" HeaderText="项目单位"></asp:BoundField>
                            <asp:BoundField DataField="9" HeaderText="项目类别"></asp:BoundField>
                            <asp:BoundField DataField="10" HeaderText="所属领域"></asp:BoundField>
                            <asp:BoundField DataField="11" HeaderText="实施阶段"></asp:BoundField>
                            <asp:BoundField DataField="12" HeaderText="合作方式"></asp:BoundField>
                            <asp:BoundField DataField="13" HeaderText="省里推荐指数"></asp:BoundField>
                            <asp:BoundField DataField="14" HeaderText="联系人"></asp:BoundField>
