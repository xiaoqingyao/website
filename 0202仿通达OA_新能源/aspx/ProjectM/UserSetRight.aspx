<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserSetRight.aspx.cs" Inherits="FTD.Web.UI.aspx.ProjectM.UserSetRight" %>
            ...
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="right" valign="middle" style="height: 30px;">查询：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="80px"></asp:TextBox>
                        ...
                        <asp:Button ID="iButton1" runat="server" CssClass="btn btn-aqua" Text="保存" />
                ...
                <td>
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="2" HeaderText="性别"></asp:BoundField>
                            <asp:BoundField DataField="3" HeaderText="职位"></asp:BoundField>
                            <asp:BoundField DataField="4" HeaderText="所属部门"></asp:BoundField>                            
