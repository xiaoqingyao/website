<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RiBaoList.aspx.cs" Inherits="FTD.Web.UI.aspx.WorkPlanM.RiBaoList" %>
            ...
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="middle" style="height: 30px;">&nbsp;<img src="../../images/BanKuaiJianTou.gif" />
                        <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;工作汇报&nbsp;>>&nbsp;日报列表
                    </td>
                    <td align="right" valign="middle" style="height: 30px;">
                        <label style="color: red">
                            【操作提示】：您可以勾选多个计划快速生成工作日报、周报、月报或专项工作汇报。
                        </label>
                        查询：<asp:TextBox ID="TextBox1" runat="server" Height="30px" Width="80px" />
                        ...
                        <asp:Button ID="Button1" runat="server" CssClass="btn btn-aqua" Text="通过计划生成日报" />
                ...
                <td>
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="汇报标题">
                                <ItemTemplate>
                            ...
                            <asp:BoundField DataField="2" HeaderText="汇报人"></asp:BoundField>
                            <asp:BoundField DataField="3" HeaderText="汇报日期"></asp:BoundField>
                            <asp:BoundField DataField="4" HeaderText="工作日期从"></asp:BoundField>
                            <asp:BoundField DataField="5" HeaderText="工作日期到"></asp:BoundField>
                            <asp:BoundField DataField="6" HeaderText="附件下载"></asp:BoundField>
