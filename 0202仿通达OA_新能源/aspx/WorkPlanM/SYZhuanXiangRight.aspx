<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SYZhuanXiangRight.aspx.cs" Inherits="FTD.Web.UI.aspx.WorkPlanM.SYZhuanXiangRight" %>
            ...
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="middle" style="height: 30px;">&nbsp;<img src="../../images/BanKuaiJianTou.gif" />
                        <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;工作汇报&nbsp;>>&nbsp;专项工作汇报情况
                    </td>
                    <td align="right" valign="middle" style="height: 30px;">
                        <label style="color: red">
                            【操作提示】：您可以通过左侧的人员节点查看该职工的工作汇报情况。
                        </label>
