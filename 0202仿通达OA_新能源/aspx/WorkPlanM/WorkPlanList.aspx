<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkPlanList.aspx.cs" Inherits="FTD.Web.UI.aspx.WorkPlanM.WorkPlanList" %>
            ...
            <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td valign="middle" style="height: 30px;">&nbsp;<img src="../../images/BanKuaiJianTou.gif" />
                        <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;计划管理&nbsp;>>&nbsp;计划列表
                    </td>
                    <td align="right" valign="middle" style="height: 30px;">
                        <label style="color:red">
                            【操作提示】：您可以勾选多个计划快速生成工作日报、周报、月报或专项工作汇报。
                        </label>
                        ...
                        <asp:Button ID="iButton3" runat="server" OnClientClick="javascript:return CheckDel();" CssClass="btn btn-red" Text="删除" />
                          <asp:Button ID="Button1" runat="server" CssClass="btn btn-aqua" Text="合并工作日报" />
                         <asp:Button ID="Button2" runat="server" CssClass="btn btn-aqua" Text="合并工作周报" />
                         <asp:Button ID="Button3" runat="server" CssClass="btn btn-aqua" Text="合并工作月报" />
                        <asp:Button ID="Button4" runat="server" CssClass="btn btn-aqua" Text="合并专项工作汇报" />
                ...
                <td>
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="计划标题">
                                <ItemTemplate>
                            ...
                            <asp:BoundField DataField="3" HeaderText="填报人"></asp:BoundField>
                            <asp:BoundField DataField="4" HeaderText="填报日期"></asp:BoundField>
                            <asp:BoundField DataField="5" HeaderText="计划日期从"></asp:BoundField>
                            <asp:BoundField DataField="6" HeaderText="计划日期到"></asp:BoundField>
                            <asp:BoundField DataField="7" HeaderText="是否项目工作计划"></asp:BoundField>
                            <asp:BoundField DataField="8" HeaderText="项目"></asp:BoundField>
                            <asp:BoundField DataField="2" HeaderText="附件下载"></asp:BoundField> 
