<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectItemReportList.aspx.cs" Inherits="FTD.Web.UI.aspx.ProjectM.ProjectItemReportList" %>
                ...
                <td>
                    <asp:GridView ID="GVData" CssClass="gridview_m" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="3" HeaderText="报告时间"></asp:BoundField>
                            <asp:BoundField DataField="4" HeaderText="报告人"></asp:BoundField>
                            <asp:BoundField DataField="5" HeaderText="项目进度"></asp:BoundField>
                            <asp:BoundField DataField="6" HeaderText="负责人"></asp:BoundField>
                            <asp:BoundField DataField="7" HeaderText="联系电话"></asp:BoundField>
                            <asp:BoundField DataField="8" HeaderText="执行情况说明"></asp:BoundField>
