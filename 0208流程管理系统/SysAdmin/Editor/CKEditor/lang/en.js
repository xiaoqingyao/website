...
(function() {
    CKEDITOR.lang.en = {
        ...
        importword:{
            ...
            NotNull:'Choose to import the Word document',
            ImportErr: 'Import failed, presumably because the network, please wait in the test',
            wait:'Please wait....',
            disable:'Note: This feature can only be used in the IE browser, your current browser does not support this feature, <br> For using this feature, please use the IE browser, following the withdrawal of open and log in using the',
            removestyle: 'Remove the word style',
            NotAllowFileType: 'You select the document type is not correct',
            Failure: 'Import failed, because you may not install the machine Word, or Word version does not correct (to support 2003 and 2007)'
        },
        importexcel: {
            title: 'Import Excel Document',
            name: 'Select Documents',
            NotNull: 'Choose to import the Excel document',
            ImportErr: 'Import failed, presumably because the network, please wait in the test',
            wait: 'Please wait....',
            disable: 'Note: This feature can only be used in the IE browser, your current browser does not support this feature, <br> For using this feature, please use the IE browser, following the withdrawal of open and log in using the',
            removestyle: 'Remove the excel style',
            NotAllowFileType: 'You select the document type is not correct',
            Failure: 'Import failed, because you may not install the machine Excel, or Excel version does not correct (to support 2003 and 2007)'
        },
        importppt: {
            title: 'Import PPT Document',
            name: 'Select Documents',
            NotNull: 'Choose to import the PPT document',
            ImportErr: 'Import failed, presumably because the network, please wait in the test',
            wait: 'Please wait....',
            disable: 'Note: This feature can only be used in the IE browser, your current browser does not support this feature, <br> For using this feature, please use the IE browser, following the withdrawal of open and log in using the',
            removestyle: 'Remove the PPT style',
            NotAllowFileType: 'You select the document type is not correct',
            Failure: 'Import failed, because you may not install the machine PPT, or PPT version does not correct (to support 2003 and 2007)'
        },
        maximize: 'Maximize',
        minimize: 'Minimize',
        fakeobjects: {
