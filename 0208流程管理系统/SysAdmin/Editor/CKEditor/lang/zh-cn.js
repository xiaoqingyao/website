...
(function() {
    CKEDITOR.lang['zh-cn'] = {
        ...
        importword:{
            title:'导入Word文档',
            name: '选择文档',
            NotNull:'请选择需要导入的Word文档',
            ImportErr:'导入失败,估计是网络原因,请稍候在试',
            wait:'请稍等....',
            disable:'提示：该功能只能在IE浏览器中使用，你目前的浏览器不支持此功能，<br>如需使用此功能，请退出后用IE浏览器打开并登录后使用',
            removestyle: '移除Word样式',
            NotAllowFileType: '你选择的文档类型不正确',
            Failure: '导入失败，原因是可能你机器未安装Word，或者Word版本不正确（支持2003和2007）'
        },
        importexcel: {
            title: '导入Excel文档',
            name: '选择文档',
            NotNull: '请选择需要导入的Excel文档',
            ImportErr: '导入失败,估计是网络原因,请稍候在试',
            wait: '请稍等....',
            disable: '提示：该功能只能在IE浏览器中使用，你目前的浏览器不支持此功能，<br>如需使用此功能，请退出后用IE浏览器打开并登录后使用',
            removestyle: '移除Excel样式',
            NotAllowFileType: '你选择的文档类型不正确',
            Failure: '导入失败，原因是可能你机器未安装Excel，或者Excel版本不正确（支持2003和2007）'
        },
        importppt: {
            title: '导入PPT文档',
            name: '选择文档',
            NotNull: '请选择需要导入的PPT文档',
            ImportErr: '导入失败,估计是网络原因,请稍候在试',
            wait: '请稍等....',
            disable: '提示：该功能只能在IE浏览器中使用，你目前的浏览器不支持此功能，<br>如需使用此功能，请退出后用IE浏览器打开并登录后使用',
            removestyle: '移除PPT样式',
            NotAllowFileType: '你选择的文档类型不正确',
            Failure:'导入失败，原因是可能你机器未安装PPT，或者PPT版本不正确（支持2003和2007）'
        },
