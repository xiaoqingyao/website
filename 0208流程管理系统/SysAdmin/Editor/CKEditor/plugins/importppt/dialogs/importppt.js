...
return {
    ...
    onOk: function() {
        ...
        if (uploadvalue != "" && uploadvalue.indexOf(".") != -1) {
            ...
            try {
                activex = new ActiveXObject("ToprandActiveX.ImportPPT");
            ...
            alert(a.lang.importppt.NotNull);
            return false;
        }
        return true;
    },
    contents: [{
        ...
        elements: [{
            ...
            html: '<div id=div_Enable>' + a.lang.importppt.name + '<br><iframe name="ajaxifr" id="ajaxifr" src="../Editor/ImportEditor/ImportWord.aspx" frameborder=0 scrolling=no style="width:360px;height:40px"></iframe><div align=center id="waitimg" style="width:360px;display:none;">' + a.lang.importppt.wait + ' <img src="../Editor/CKEditor/images/pleasewait.gif"></div> </div><div style="display:none" id=div_Disable>' + a.lang.importppt.disable + '</div>'
        ...
        },
            {
                ...
                children: [{
                    type: 'checkbox',
                    id: 'ignoreFontFace',
                    label: a.lang.importppt.removestyle,
                    hidden: ishidden(),
...
function getHtml(obj1) {
    ...
    try {
        ...
        alert(importobj.lang.importppt.Failure);
    }
