...
//                jQuery(el.fisheyeCfg.itemsText, this).get(0).style.display = 'none'
            ...
            function(e) {
                ...
                el.fisheyeCfg.items.each(function(nr) {
                    ...
                    this.style.left = el.fisheyeCfg.itemWidth * nr+30*nr  + 'px';
                    toAdd += extraWidth
                });
    ...
    positionContainer: function(el, toAdd) {
        if (el.fisheyeCfg.halign) if (el.fisheyeCfg.halign == 'center') el.fisheyeCfg.container.get(0).style.left = "-300" + 'px';
        else if (el.fisheyeCfg.halign == 'left') el.fisheyeCfg.container.get(0).style.left = "0" + 'px';
        ...
        el.fisheyeCfg.container.get(0).style.width = "700" + 'px'
    },
