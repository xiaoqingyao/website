...
function CoupletZoneAD_WriteAD(ShowAD,DivName,Left){
  ...
  if(this.ShowCloseAD){
      document.write("<div style='position: absolute;right: 0px;bottom: 0px;'><span style='cursor: pointer;' onclick='AD_CloseDL(\"" + DivName + "\");' style='font-size:12px;color:" + this.CloseFontColor + ";text-decoration:none;'>¹Ø±Õ</span></div>");
  }
  document.write("</div>");
}
...
var ZoneAD_1=new CoupletZoneAD("ZoneAD_1"); 
...
ZoneAD_1.ZoneID='000000000132380';ZoneAD_1.ZoneWidth=234;ZoneAD_1.ZoneHeight=60;ZoneAD_1.ShowType=2;ZoneAD_1.Left=15;ZoneAD_1.Top=200;ZoneAD_1.Delta=0.0149999996647239;ZoneAD_1.ShowCloseAD=false;ZoneAD_1.CloseFontColor='#FFFFFF';ZoneAD_1.Show();