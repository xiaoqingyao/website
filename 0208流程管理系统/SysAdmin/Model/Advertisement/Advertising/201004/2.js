...
function FixedZoneAD_Show() {
  ...
  if(this.ShowCloseAD){
      document.write("<div style='position: absolute;right: 0px;bottom: 0px;'><span style='cursor: pointer;' onclick='AD_CloseDL(\"" + this.DivName + "\");' style='font-size:12px;color:" + this.CloseFontColor + ";text-decoration:none;'>¹Ø±Õ</span></div>");
  }
  document.write("</div>");
...
objAD.ADID='000000000336416';objAD.ADType=2;objAD.ADName='Í¼Æ¬2';objAD.ImgUrl='';objAD.ImgWidth=0;objAD.ImgHeight=100;objAD.FlashWmode=0;objAD.ADIntro='';objAD.LinkUrl='';objAD.LinkTarget=0;objAD.LinkAlt='';objAD.Priority=100;objAD.CountView=true;objAD.CountClick =true;objAD.OverdueDate='2010/08/08';objAD.ADDIR= 'SysAdmin/Model'; objAD.InstallDir='/';ZoneAD_1.AddAD(objAD);
var objAD = new ObjectAD(); 
objAD.ADID='000000000279398';objAD.ADType=1;objAD.ADName='t13';objAD.ImgUrl='';objAD.ImgWidth=0;objAD.ImgHeight=100;objAD.FlashWmode=0;objAD.ADIntro='';objAD.LinkUrl='http://';objAD.LinkTarget=1;objAD.LinkAlt='';objAD.Priority=100;objAD.CountView=true;objAD.CountClick =false;objAD.OverdueDate='2010/08/19';objAD.ADDIR= 'SysAdmin/Model'; objAD.InstallDir='/';ZoneAD_1.AddAD(objAD);
ZoneAD_1.ZoneID='000000000279398';ZoneAD_1.ZoneWidth=160;ZoneAD_1.ZoneHeight=600;ZoneAD_1.ShowType=1;ZoneAD_1.LocalityType=1;ZoneAD_1.Left=100;ZoneAD_1.Top=100;ZoneAD_1.ShowCloseAD=false;ZoneAD_1.CloseFontColor='#FFFFFF';ZoneAD_1.Show();