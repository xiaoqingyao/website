<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdvertisingEdit.aspx.cs"
    Inherits="AllPower.Web.Admin.AdvertisingEdit" ValidateRequest="false" %>
...
<body>
    ...
    <div class="container">
        <h4>
            位置： <a href="#">广告管理</a> > <a href="AdvertisingList.aspx?NodeCode=<%=NodeCode %>">>广告位管理</a>
            ><span style="color: Blue"> 添加广告位</span></h4>
        <dl>
            <dt>
        ...
        <dl>
            <dt>js名字:</dt>
            <dd>
                <asp:TextBox ID="txtJsName" runat="server" Enabled="false"></asp:TextBox>*
            </dd>
        </dl>
        <dl>
            <dt>
