...
<div id="panel"><dl><dt>产品名称：</dt><dd id="K_U_Album_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Album" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000039015623" runat="server" />
</div>
