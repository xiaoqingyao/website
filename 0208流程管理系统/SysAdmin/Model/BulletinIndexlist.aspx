...
<div class="container"id="_ListInfoListTable">
  <h4>位置： <%GetPageNav(NodeCode);%></h4>
      ...
      <div id="searchContainer">
        <ul>
        <li>公告名称</li><li><input   type="text" value="" style="width:200px;"  maxlength="650" name="Sup_Name" id="Sup_Name" /></li><li>披露日期</li><li>从：</li><li><li><input id="SupDate"  value=""   name="SupDate" style="width:140px;"  class="Wdate" type="text" onFocus="WdatePicker({lang:'<%=Resources.Model.DateLang%>',skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/></li></li><li>到：</li><li><input id="SupDate{0}"  value=""   name="SupDate{0}" style="width:140px;"  class="Wdate" type="text" onFocus="WdatePicker({lang:'<%=Resources.Model.DateLang%>',skin:'whyGreen',dateFmt:'yyyy-MM-dd'})"/></li>
   ...
   <asp:HiddenField ID="hdnNotSearchField" runat="server" value="" /><asp:HiddenField ID="hdnBackDeliverUrlParam" runat="server" value="NodeCode"  /> <asp:HiddenField ID="hdnModelID" Value="100000040392187" runat="server" /><asp:HiddenField ID="hdnTableName" Value="K_U_BulletinIndex" runat="server" />  <asp:HiddenField ID="hdnDeliverAndSearchUrlParam" runat="server"  Value=""/> <input type="hidden" value="" id="HQB_Model_DeliverUrlParam" /><asp:HiddenField ID="hdnCustomCol" Value="" runat="server" />   <asp:HiddenField ID="hdnForignTableCol" value="K_ReviewFlowState|K_U_BulletinIndex.FlowState|Name|StateValue" runat="server" /><asp:HiddenField ID="hdnShowCol" value="K_U_BulletinIndex.ID,K_U_BulletinIndex.FlowState,K_U_BulletinIndex.Sup_Name,K_U_BulletinIndex.SupDate,K_U_BulletinIndex.Orders" runat="server" />
