...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Calendar_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Calendar" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000046025476" runat="server" />
</div>
