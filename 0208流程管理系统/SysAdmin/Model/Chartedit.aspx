...
<div class="Submit" id="HQB_Operation_Button">
 ...
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_Chart" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Title||1," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000046723559" runat="server" /><input type="hidden" id="hdnModelAlias" value="图表模型" name="hdnModelAlias"/> 
