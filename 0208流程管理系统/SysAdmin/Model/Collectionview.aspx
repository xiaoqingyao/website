...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Collection_C_Title"><%=hsFieldValue["C_Title"]%></dd></dl><dl><dt>内容：</dt><dd id="K_U_Collection_C_Content"><%=hsFieldValue["C_Content"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Collection" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000073165723" runat="server" />
</div>
