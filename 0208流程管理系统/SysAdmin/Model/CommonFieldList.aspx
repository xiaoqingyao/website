<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommonFieldList.aspx.cs"   Inherits="AllPower.Web.Admin.CommonFieldList" %>
        ...
        <asp:Repeater ID="rptModelField" runat="server">
            <ItemTemplate>
                <ul class="ulheader ulbody" onmouseover="$(this).addClass('rowSelected')" onmouseout="$(this).removeClass('rowSelected')">
                    ...
                    <li  style="width:60px;">
                        <asp:LinkButton ID="LinkButton4" OnCommand="SetIsEnable" CommandArgument='<%#Eval("ID").ToString() + "|" + Eval("IsSearch").ToString()%>' CommandName="ISSEARCH" runat="server"><%#AllPower.Common.Utils.ParseIsOrNot(Eval("IsSearch"), "否")%></asp:LinkButton>&nbsp;
                    </li>
                    <li style="width:60px;">
                        <asp:LinkButton ID="LinkButton3" OnCommand="SetIsEnable" CommandArgument='<%#Eval("ID").ToString() + "|" + Eval("IsListEnable").ToString()%>' CommandName="ISLIST" runat="server"><%#AllPower.Common.Utils.ParseIsOrNot(Eval("IsListEnable"), "否")%></asp:LinkButton>
                    </li>
                    <li style="width:60px;">
                        <asp:LinkButton ID="LinkButton5" OnCommand="SetIsEnable" CommandArgument='<%#Eval("ID").ToString() + "|" + Eval("IsInputValue").ToString()%>' CommandName="ISEDIT" runat="server"><%#AllPower.Common.Utils.ParseIsOrNot(Eval("IsInputValue"), "否")%></asp:LinkButton>
                    </li>
                    <li style="width:40px;">
                    <asp:LinkButton ID="LinkButton2" OnCommand="SetIsEnable" CommandArgument='<%#Eval("ID").ToString() + "|" + Eval("IsEnable").ToString()%>' CommandName="STATE" runat="server"><%#AllPower.Common.Utils.ParseState(Eval("IsEnable"),"状态不明")%></asp:LinkButton></li>
                    <li style="width:40px;">
                    <asp:LinkButton ID="LinkButton1" OnCommand="SetIsEnable" CommandArgument='<%#Eval("ID").ToString() + "|" + Eval("IsRequired").ToString()%>' CommandName="REQUIRED" runat="server"><%#AllPower.Common.Utils.ParseIsOrNot(Eval("IsRequired"), "否")%></asp:LinkButton>
                   </li>
                    ...
                    <li style="width:80px;">
                        <asp:LinkButton ID="LinkButton6" OnCommand="SetIsEnable" CommandArgument='<%#Eval("ID").ToString() + "|" + Eval("IsDefault").ToString()%>' CommandName="ISDEFAULT" runat="server"><%#AllPower.Common.Utils.ParseIsOrNot(Eval("IsDefault"), "否")%></asp:LinkButton>
                    </li>
