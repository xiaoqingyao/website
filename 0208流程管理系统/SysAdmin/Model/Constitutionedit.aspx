...
<div id="panel"><dl><dt>章程标题</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["ConTitle"]%>" style="width:300px;"  maxlength="30" name="ConTitle" id="ConTitle" /></dd></dl><%AllPower.Config.UploadConfig uploadobj = AllPower.Config.Upload.GetConfig(GetUploadImgPath); %><dl><dt>章程内容</dt><dd><textarea  id="ConContent" name="ConContent"><%=hsFieldValue["ConContent"]%></textarea><script type="text/javascript">    var ConContent$$ckeditor$$obj = CKEDITOR.replace('ConContent', { language: '<%=Resources.Model.DateLang%>', height: '300px',width:'650px' }); </script></dd></dl></div>
<div class="Submit" id="HQB_Operation_Button">
 <asp:Button ID="btnModelManageEdit" OnClick="Edit"  runat="server" />
 <input type="button" value="返回" onclick="back()" />
 </div>
</div>
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_Constitution" ID="hdnTableName" runat="server" /><asp:HiddenField Value="ConTitle||1,ConContent||3," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000001628125" runat="server" /><input type="hidden" id="hdnModelAlias" value="公司章程模型" name="hdnModelAlias"/> 
