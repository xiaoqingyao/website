...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Datetable_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Datetable" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000045376943" runat="server" />
</div>
