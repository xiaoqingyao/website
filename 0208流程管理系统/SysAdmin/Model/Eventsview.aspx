...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Events_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Events" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000007434375" runat="server" />
</div>
