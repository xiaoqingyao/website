<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FieldManageEdit.aspx.cs"
    Inherits="AllPower.Web.Admin.FieldManageEdit" EnableEventValidation="false" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            var name = "字段编辑";
            var listUrl = "FieldManageList.aspx?<%=UrlParam %>";
            var addUrl = "FieldManageEdit.aspx?action=add&<%=UrlParam %>";
            var updateUrl = "FieldManageEdit.aspx?action=edit&<%=UrlParam %>&id=" + id;
    ...
    <div class="container">
        ...
        <dl>
            ...
            <dd>
                ...
                <span style="color: #ff0000;" id="CheckNameISRepeatMSG"></span>*注：字段名由字母、数字、下划线组成，并且仅能字母开头，不以下划线结尾</dd>
        </dl>
        <dl>
            <dt>所属分组：</dt>
            <dd>
                <asp:DropDownList ID="ddlModelFieldGroupId" runat="server">
                </asp:DropDownList>
            </dd>
        </dl>
        <dl>
        ...
        <dl>
            ...
            <dd>
                <asp:RadioButtonList ID="radlBasicField" runat="server" RepeatColumns="6" RepeatDirection="Horizontal">
                    ...
                    <asp:ListItem Value="14" Text="子模型"></asp:ListItem>
                </asp:RadioButtonList>
            </dd>
        </dl>
        <dl id="BasicField_TextBoxWidth">
            ...
            <dd>
                <asp:TextBox runat="server" ID="txtTextBoxWidth" Text="100"></asp:TextBox>px</dd>
        </dl>
        <dl id="BasicField_TextBoxHeight">
            <dt>
                <%=Resources.Model.txtBoxHeight%></dt>
            <dd>
                <asp:TextBox runat="server" ID="txtTextBoxHieght" Text="30"></asp:TextBox>px</dd>
        </dl>
        <div id="BasicField_1">
            <dl>
                <dt>
                ...
                <dd>
                    <asp:TextBox runat="server" ID="txtTextBoxMaxLength" Text="30"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>
                    <%=Resources.Model.ValidationTypes%></dt>
                <dd>
                    <asp:RadioButtonList ID="radlValidationType" runat="server" RepeatDirection="Horizontal">
                    </asp:RadioButtonList>
                </dd>
            </dl>
            <div id="BasicField_Validation" style="display: none;">
                ...
                <dl>
                    ...
                    <dd>
                        <asp:TextBox runat="server" ID="txtTextBoxValidation"></asp:TextBox></dd>
                </dl>
            </div>
        </div>
        <div id="BasicField_3">
        ...
        <div id="BasicField_4">
            ...
            <div id="DropDownDataType2" style="display: none">
                <dl>
                    ...
                    <dd>
                        <asp:DropDownList ID="ddlDropDownTable" runat="server" onchange="selectColumn(this.value)">
                        </asp:DropDownList>
                    </dd>
                </dl>
                <dl>
                    ...
                    <dd>
                        <asp:DropDownList ID="ddlDropDownTextColumn" runat="server" onchange="selectColumnSql()">
                        </asp:DropDownList>
                ...
                <dl>
                    ...
                    <dd>
                        <asp:DropDownList ID="ddlDropDownValueColumn" runat="server" onchange="selectColumnSql()">
                        </asp:DropDownList>
                ...
                <dl>
                    ...
                    <dd>
                        <asp:TextBox runat="server" ID="txtDropDownSqlWhere" onchange="selectColumnSql()"></asp:TextBox></dd>
                </dl>
                <dl>
                    <dt>
        ...
        <div id="BasicField_5">
            <dl>
                ...
                <dd>
                    <asp:TextBox runat="server" ID="txtOptionCount" Text="0"></asp:TextBox><%=Resources.Model.ModelFieldOptionCountValue%></dd>
            </dl>
        </div>
        <div id="BasicField_8">
            ...
            <dl>
                ...
                <dd>
                    <asp:RadioButtonList runat="server" ID="radlDateDefaultOption" RepeatDirection="Horizontal">
                        <asp:ListItem Selected="True" Value="1" onclick="displayContainer('BasicField_DefaultValue',false)"
                            Text='<%$Resources:Model,ModelFiledNull%>'></asp:ListItem>
                        <asp:ListItem Value="2" onclick="displayContainer('BasicField_DefaultValue',false)"
                            Text='<%$Resources:Model,ModelFiledToday%>'></asp:ListItem>
                        <asp:ListItem Value="3" onclick="displayContainer('BasicField_DefaultValue',true)"
        ...
        <div id="BasicField_11">
            <dl id="BasicField_ImagesThumb" style="display: none;">
                <dt>缩略图尺寸：</dt>
                <dd>
                    宽 &nbsp;<asp:TextBox ID="txtThumbWidth" Text="125" runat="server"></asp:TextBox>px&nbsp;&nbsp;&nbsp;高&nbsp;<asp:TextBox
                        ID="txtThumbHeight" Text="125" runat="server"></asp:TextBox>px</dd>
            </dl>
            <dl>
                <dt>是否多文件：</dt>
                <dd>
                    <asp:RadioButtonList ID="radlIsMultiFile" runat="server" RepeatDirection="Horizontal">
                        <asp:ListItem Value="1" Text='<%$Resources:Common,Yes%>' onclick="isMultiFieldClick(true)"></asp:ListItem>
                        <asp:ListItem Value="0" Selected="True" onclick="isMultiFieldClick(false)"
                            Text='<%$Resources:Common,No%>'></asp:ListItem>
                    </asp:RadioButtonList>
                </dd>
            </dl>
            <span id="BasicField_IsAlbums" style="display:none;">
            <dl>
                <dt>是否相册：</dt>
                <dd>
                <asp:RadioButtonList ID="radlIsAlbums" runat="server" RepeatDirection="Horizontal">
                <asp:ListItem Value="1" Text='<%$Resources:Common,Yes%>' onclick="isAlbumsClick(false);"></asp:ListItem>
                <asp:ListItem Value="0" Selected="True" onclick="isAlbumsClick(true)" Text='<%$Resources:Common,No%>'></asp:ListItem>
                </asp:RadioButtonList>
                </dd>
            </dl>
            <dl>
            <dt>是否上传缩略图：</dt>
            <dd>
            <asp:RadioButtonList ID="radlIsAlbumsUploadThumb" runat="server" RepeatDirection="Horizontal">
            ...
            <dl>
                <dt>是否描述：</dt>
                <dd><asp:RadioButtonList ID="radlIsAlbumsDesc" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Value="1"  Selected="True" Text='<%$Resources:Common,Yes%>'></asp:ListItem>
            ...
            <div id="BasicField_AllowUpload">
                <dl>
                    ...
                    <dd>
                        <asp:TextBox runat="server" ID="txtMaxSize" Text="4096"></asp:TextBox>KB</dd>
                </dl>
                <dl>
                    <dt>
                ...
                <dd>
                    <ul style="list-style: none;">
                        <li style="list-style: none; float: left;">
                            <asp:CheckBox ID="chkIsSaveFileSize" runat="server" Checked="true" onclick="displayContainer('BasicField_IsSaveFileSize',this.checked)" /><%=Resources.Common.Save%></li>
                        <li style="list-style: none; float: left; margin-left: 10px;" id="BasicField_IsSaveFileSize">
                            <asp:TextBox runat="server" ID="txtSaveFileName"></asp:TextBox><%=Resources.Model.ModelFileSaveName%></li>
                    </ul>
                </dd>
            </dl>
        </div>
        
        <div id="BasicField_14">
        <dl>
            <dt>类型：</dt>
            
            <dd><asp:DropDownList ID="ddlRelatedType" runat="server">
                <asp:ListItem Value="1" Text="子模型" Selected="True"></asp:ListItem>
                <asp:ListItem Value="2" Text="子模型分组"></asp:ListItem>
            </asp:DropDownList></dd>
        </dl>
        <dl id="BasicField_14_Single">
            <dt>子模型</dt>
            <dd>
                <asp:DropDownList ID="ddlSubModelName" runat="server">
                </asp:DropDownList>
            </dd>
        </dl>
        <dl id="BasicField_14_Group" style="display:none;">
            <dt>子模型分组：</dt>
            <dd>
                ...
                <ul id="IsListEnableDisplay" style="display: none; list-style: none; margin: 2px;">
                    ...
                    <li style="padding: 0; margin: 0; padding-left: 5px;">
                        <ul style="list-style: none; margin: 0px; padding: 0;">
                            <li style="padding-left: 5px; float: left;">
                                <%=Resources.Model.ModelFiledIsLink%><asp:CheckBox ID="chkListIsLink" runat="server"
                                    onclick="displayContainer('ListIsLinkDisplay',this.checked)" /></li>
                    ...
                    <li style="padding: 0; margin: 0; padding-left: 5px; clear: both;">
                        <ul style="list-style: none; margin: 0px; padding: 0;">
                            <li style="padding-left: 5px; float: left;">
                                <%=Resources.Model.ModelFiledIsOrder%><asp:CheckBox ID="chkListIsOrder" runat="server"
                                    Checked="true" onclick="displayContainer('ListIsOrderDisplay',this.checked)" /></li>
                        ...
                        <ul style="list-style: none; margin: 0px; padding: 0;">
                            <li style="margin: 0; padding: 0; float: left; padding-left: 15px;">
                                <ul style="margin: 0; padding: 0; list-style: none;">
                                    <li style="float: left;">列表缩略图显示方式</li><li style="float: left;">
                                        <asp:RadioButtonList ID="radlThumbDisplayType" runat="server" RepeatDirection="Horizontal"
                                            RepeatColumns="5">
        ...
        <dl style="display: none;">
            <dt>是否RSS字段：</dt>
            <dd>
                <asp:RadioButtonList ID="radlIsRss" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Selected="True" Value="1" Text='<%$Resources:Common,Yes%>'></asp:ListItem>
                    <asp:ListItem Value="0" Text='<%$Resources:Common,No%>'></asp:ListItem>
                </asp:RadioButtonList>
            </dd>
        ...
        <dl>
            <dt>是否在接口列表中显示：</dt>
            <dd>
                <asp:RadioButtonList ID="radlIsInterface" runat="server" RepeatDirection="Horizontal">
                    <asp:ListItem Value="1" Text='<%$Resources:Common,Yes%>'></asp:ListItem>
                    <asp:ListItem Selected="True" Value="0" Text='<%$Resources:Common,No%>'></asp:ListItem>
                </asp:RadioButtonList>
            </dd>
        ...
        <div class="Submit">
            ...
            <input type="button" name="Submit422" value="<%=Resources.Common.Back%>" onclick="javascript:location.href='FieldManageList.aspx?<%=UrlParam %>';">
        </div>
        <asp:HiddenField ID="hdnAction" runat="server" />
        <asp:HiddenField ID="hdnBasicField" runat="server" />
        <asp:HiddenField ID="hdnOriginalDefaultValue" runat="server" />
        <asp:HiddenField ID="hdnOriginalDataColumnLength" runat="server" />
