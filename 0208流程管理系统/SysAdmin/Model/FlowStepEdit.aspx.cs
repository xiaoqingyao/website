...
namespace AllPower.Web.Admin
{
    public partial class FlowStepEdit : AdminPage
    {
        ...
        private void PageInit()
        {
            ...
            BLL.SysManage.UserGroup useGroup = new AllPower.BLL.SysManage.UserGroup();
            AllPower.Model.SelectParams selectParam = new AllPower.Model.SelectParams();
            ...
            //绑定用户角色
            BLL.SysManage.Role bllRole = new AllPower.BLL.SysManage.Role();
        ...
        {
            modelFlowStep = new AllPower.Model.Content.FlowStep();
            ModelSaveOrUpdate();
