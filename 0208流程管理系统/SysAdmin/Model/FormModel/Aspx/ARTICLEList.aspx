...
<asp:HiddenField ID="hdnShowCol" value=",K_F_ARTICLE.orders" runat="server" /><asp:HiddenField ID="hdnModelID" Value=100000005086275 runat="server" /><asp:HiddenField ID="hdnTableName" Value="K_F_ARTICLE" runat="server" /> 
</form>
</body>
</html>
