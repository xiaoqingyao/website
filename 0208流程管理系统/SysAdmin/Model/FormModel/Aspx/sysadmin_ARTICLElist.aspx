...
<body>
   ...
   <asp:HiddenField ID="hdnModelID" Value="100000005086275" runat="server" /><asp:HiddenField ID="hdnTableName" Value="K_F_ARTICLE" runat="server" /><asp:HiddenField ID="hdnCustomCol" Value="" runat="server" />   <asp:HiddenField ID="hdnForignTableCol" value="" runat="server" /><asp:HiddenField ID="hdnShowCol" value="1 as ktype" runat="server" />
   </form>
