<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomFormList.aspx.cs" Inherits="AllPower.Web.Admin.ControlFormList" %>
...
<asp:HiddenField ID="hdnShowCol" value=",K_F_zx.orders" runat="server" /><asp:HiddenField ID="hdnModelID" Value=000000000279398 runat="server" /><asp:HiddenField ID="hdnTableName" Value="K_F_zx" runat="server" /> 
</form>
</body>
</html>
