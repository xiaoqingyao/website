...
<div id="panel"><dl><dt>链接名称</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["F_name"]%>" style="width:140px;"  maxlength="50" name="F_name" id="F_name" /></dd></dl><dl><dt>链接地址</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["F_Link"]%>" style="width:140px;"  maxlength="50" name="F_Link" id="F_Link" /></dd></dl><dl><dt>描述</dt><dd><textarea style="height:150px;width:300px;"   class="validate[optional]"  id="Remark"  name="Remark"><%=hsFieldValue["Remark"]%></textarea></dd></dl></div>
<div class="Submit" id="HQB_Operation_Button">
 <asp:Button ID="btnModelManageEdit" OnClick="Edit"  runat="server" />
 <input type="button" value="返回" onclick="back()" />
 </div>
</div>
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_FriendLink" ID="hdnTableName" runat="server" /><asp:HiddenField Value="F_name||1,F_Link|http://|1,Remark||2," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000042437538" runat="server" /><input type="hidden" id="hdnModelAlias" value="友情链接" name="hdnModelAlias"/> 
