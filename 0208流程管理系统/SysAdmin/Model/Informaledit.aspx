...
<div class="Submit" id="HQB_Operation_Button">
 ...
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_Informal" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Title||1," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000048112197" runat="server" /><input type="hidden" id="hdnModelAlias" value="消息模型" name="hdnModelAlias"/> 
