...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Informal_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Informal" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000048112197" runat="server" />
</div>
