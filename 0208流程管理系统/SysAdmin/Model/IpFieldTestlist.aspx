...
<div class="container"id="_ListInfoListTable">
  <h4>位置： <a href="#">系统管理</a><a> ></a> <a href="#">模型管理布</a><a> ></a> <span class="breadcrumb_current" > 增加文章</span> </h4>
   ...
   <asp:HiddenField ID="hdnNotSearchField" runat="server" value="" /><asp:HiddenField ID="hdnBackDeliverUrlParam" runat="server" value="NodeCode"  /> <asp:HiddenField ID="hdnModelID" Value="100000039052490" runat="server" /><asp:HiddenField ID="hdnTableName" Value="K_F_IpFieldTest" runat="server" />  <asp:HiddenField ID="hdnDeliverAndSearchUrlParam" runat="server"  Value=""/> <input type="hidden" value="" id="HQB_Model_DeliverUrlParam" /><asp:HiddenField ID="hdnCustomCol" Value="" runat="server" />   <asp:HiddenField ID="hdnForignTableCol" value="" runat="server" /><asp:HiddenField ID="hdnShowCol" value="K_F_IpFieldTest.ID,K_F_IpFieldTest.FlowState,K_F_IpFieldTest.Orders" runat="server" />
