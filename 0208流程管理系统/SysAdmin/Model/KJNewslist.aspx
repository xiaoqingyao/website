<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KJNewslist.aspx.cs" Inherits="AllPower.WEB.SysAdmin.Model.KJNewslist" %>
...
<div class="container">
     <h4>位置： <a href="#">系统管理</a><a> &gt;</a> <a href="#">科室简介</a><a> &gt;</a> <span class="breadcrumb_current" > <a href="#">科室要闻</a></span> </h4>
    ...
    <ul class="ulheader">
        ...
        <li style="width:120px;">所属科室</li>
        <li style="width:120px;">发布日期</li>
            ...
            <ItemTemplate>
               <ul class="ulheader ulbody">
                <li style="width:5%;">
                    ...
                    <li style="width:200px;"><%#Eval("Title")%></li>
                    <li style="width:120px;"><%#Eval("DepartMent")%></li>
                    <li style="width:120px;"><%#Eval("UpdateDate")%></li>
                    <li style="width:60px;">
                    ...
                    <a href="KJNewsedit.aspx?action=edit&ID=<%#Eval("ID") %>&NodeCode=<%=nodecode%>">修改</a>&nbsp;&nbsp;
