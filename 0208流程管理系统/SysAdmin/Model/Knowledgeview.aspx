...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Knowledge_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>内容：</dt><dd id="K_U_Knowledge_Content"><%=hsFieldValue["Content"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Knowledge" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000032796875" runat="server" />
</div>
