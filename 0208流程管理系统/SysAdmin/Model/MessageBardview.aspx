...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_MessageBard_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_MessageBard" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000047426599" runat="server" />
</div>
