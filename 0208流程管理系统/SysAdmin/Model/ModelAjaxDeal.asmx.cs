...
namespace AllPower.WEB.SysAdmin.Model
{
    ...
    public class SysField : System.Web.Services.WebService
    {
        ...
        {
            BLL.Content.ModelAjaxDeal ajaDeal = new AllPower.BLL.Content.ModelAjaxDeal();
        ...
        public void SetOrder(string tableName, string id, string orderValue)
        {
            ...
            {
                BLL.Content.ModelAjaxDeal ajaxDeal = new AllPower.BLL.Content.ModelAjaxDeal();
        ...
        {
            AllPower.BLL.Content.ModelAjaxDeal ajaDeal = new AllPower.BLL.Content.ModelAjaxDeal();
        ...
        {
            DataTable dt;
            AllPower.BLL.Content.ModelAjaxDeal ajaDeal;

            ajaDeal = new AllPower.BLL.Content.ModelAjaxDeal();
