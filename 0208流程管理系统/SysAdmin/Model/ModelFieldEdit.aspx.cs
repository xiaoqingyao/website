...
namespace AllPower.Web.Admin
{
    public partial class ModelFieldEdit : AdminPage
    {
        ...
        { 
            bllModelField = new AllPower.BLL.Content.ModelField();
        ...
        {           
            //绑定模型属性
            AllPower.BLL.Content.ModelManage bllModelManage = new AllPower.BLL.Content.ModelManage();
            AllPower.BLL.Content.CustomForm bllModelFrom = new AllPower.BLL.Content.CustomForm();
            ...
            AllPower.BLL.Content.ModelFieldGroup bllModelFieldGroup = new AllPower.BLL.Content.ModelFieldGroup();
            ...
            {
                AllPower.Model.SelectParams selParams = new AllPower.Model.SelectParams();
                selParams.S1 = ID;
        ...
        private void BasicFieldUpdate(ref AllPower.Model.Content.ModelField mModelField)
        {
