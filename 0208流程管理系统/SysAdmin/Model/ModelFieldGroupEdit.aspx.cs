...
namespace AllPower.Web.Admin
{
    ...
    {
        AllPower.Model.Content.ModelFieldGroup modelFileGroup; 
        BLL.Content.ModelFieldGroup bllFiledGroup = new AllPower.BLL.Content.ModelFieldGroup();
        ...
        {          
            modelFileGroup= new AllPower.Model.Content.ModelFieldGroup();
            ModelSaveOrUpdate();
