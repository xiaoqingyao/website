...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Myflow_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Myflow" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000049531823" runat="server" />
</div>
