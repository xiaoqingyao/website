...
namespace AllPower.Web.Admin
{
    ...
    {
        AllPower.Model.Content.RecyclingAssociated modelRecyclingAssociated;
        BLL.Content.RecyclingAssociated bllRecyclingAssociated = new AllPower.BLL.Content.RecyclingAssociated();
        BLL.Content.RecyclingManage bllRecyclingManage = new AllPower.BLL.Content.RecyclingManage();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            modelRecyclingAssociated = new AllPower.Model.Content.RecyclingAssociated();
            ModelSaveOrUpdate();
