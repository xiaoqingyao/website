...
<div class="Submit" id="HQB_Operation_Button">
 ...
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_Report1" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Title||1," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000048841752" runat="server" /><input type="hidden" id="hdnModelAlias" value="报表模型" name="hdnModelAlias"/> 
