...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Report1_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Report1" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000048841752" runat="server" />
</div>
