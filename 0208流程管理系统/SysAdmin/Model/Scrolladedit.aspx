...
<div id="panel"><dl><dt>名称</dt><dd><input  class="validate[required]"  type="text" value="<%=hsFieldValue["Title"]%>" style="width:300px;"  maxlength="512" name="Title" id="Title" /><span style="color:#ff0000; font-size:14px; font-weight:bold;">*</span></dd></dl><dl><dt>链接地址</dt><dd><input  class="validate[required]"  type="text" value="<%=hsFieldValue["Links"]%>" style="width:300px;"  maxlength="100" name="Links" id="Links" /><span style="color:#ff0000; font-size:14px; font-weight:bold;">*</span>输入正确的链接：http://</dd></dl><dl><dt>图片</dt><dd><input   type="text" value="<%=hsFieldValue["BigImg"]%>" style="width:300px;"  maxlength="" name="BigImg" id="BigImg" /> <input type='button' onclick="InputImages('theForm', 'BigImg', 1, '', 4096, '',1440,364)" value = '上传图片' />宽：1440px ， 高：364px</dd></dl></div>
<div class="Submit" id="HQB_Operation_Button">
 <asp:Button ID="btnModelManageEdit" OnClick="Edit"  runat="server" />
 <input type="button" value="返回" onclick="back()" />
 </div>
</div>
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_Scrollad" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Title||1,Links|http://|1,BigImg||11," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000034868753" runat="server" /><input type="hidden" id="hdnModelAlias" value="首页banner" name="hdnModelAlias"/> 
