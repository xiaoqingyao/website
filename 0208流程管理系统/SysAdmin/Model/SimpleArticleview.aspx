...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_SimpleArticle_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>内容：</dt><dd id="K_U_SimpleArticle_ArticleContent"><%=hsFieldValue["ArticleContent"]%></dd></dl></div>
<asp:HiddenField Value="K_U_SimpleArticle" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000047381254" runat="server" />
</div>
