...
<div id="panel"><dl><dt>用户名</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["UserName"]%>" style="width:300px;"  maxlength="30" name="UserName" id="UserName" /></dd></dl><dl><dt>密码</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["pwd"]%>" style="width:300px;"  maxlength="30" name="pwd" id="pwd" /></dd></dl><dl><dt>邮箱</dt><dd><input  class="validate[required,regex[^w+[-+.]w+)*@w+([-.]w+)*.w+([-.]w+)*$,邮箱格式不正确]]"  type="text" value="<%=hsFieldValue["email"]%>" style="width:300px;"  maxlength="30" name="email" id="email" /><span style="color:#ff0000; font-size:14px; font-weight:bold;">*</span></dd></dl></div>
<div class="Submit" id="HQB_Operation_Button">
 <asp:Button ID="btnModelManageEdit" OnClick="Edit"  runat="server" />
 <input type="button" value="返回" onclick="back()" />
 </div>
</div>
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_user" ID="hdnTableName" runat="server" /><asp:HiddenField Value="UserName||1,pwd||1,email||1," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000039789626" runat="server" /><input type="hidden" id="hdnModelAlias" value="用户模块" name="hdnModelAlias"/> 
