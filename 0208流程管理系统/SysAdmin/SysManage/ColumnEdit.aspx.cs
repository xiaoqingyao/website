...
namespace AllPower.WEB.SysAdmin.SysManage
{
    public partial class ColumnEdit : AdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string strurlpar = "?Action=Edit&NodeID=" + Request.QueryString["NodeID"] + "&ID=" + Request.QueryString["ID"] + "&NCode=" + NCode + "&NodeCode=" + NodeCode;
        ...
        public class Add_CheckBoxToView : ITemplate
        {
            ...
            public void InstantiateIn(System.Web.UI.Control container)
            {
                ...
                {
                    object dataItem = ((sender as System.Web.UI.Control).NamingContainer as GridViewRow).DataItem;
        ...
        private void BindGridView()
        {
            ...
            AllPower.BLL.SysManage.UserGroup bllUserGroup = new AllPower.BLL.SysManage.UserGroup();
            DataTable dt = bllUserGroup.GetList("ALL", Utils.getOneParams(SiteID.ToString())).Tables[0];

            //得到操作列表           
            AllPower.BLL.SysManage.ActionPermit bllActionPer = new ActionPermit();
            ...
            if (this.Action == "EDIT")
            {
                ...
                if (dt != null && dt.Rows.Count > 0)
                {
                    ...
                    switch (dr["ContentPageHtmlRule"].ToString())
                    {
                        ...
                        default: { radContentPageSavePathType1.Checked = true; break; }
                    }
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            ...
            mode.SubDomain = Utils.HtmlEncode(txtSubDomain.Text);
