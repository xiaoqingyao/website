<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ColumnUnite.aspx.cs" Inherits="AllPower.WEB.SysAdmin.SysManage.ColumnUnite" %>
    ...
    <script type="text/javascript">
        ...
        function setAction1(data) {
            if (!checkMultipleSelete("lsbColumn1")) {
                alert({ msg: "请选择要合并的栏目!", title: "信息提示" });
                return false;
            }
            if (!checkMultipleSelete("lsbColumn2")) {
                alert({ msg: "请选择合并到的栏目!", title: "信息提示" });
                return false;
            }
            if (data == "true") {
...
<body>
    ...
    <div class="container">
        ...
        <div id="panel">
            <fieldset style="padding:20px 50px 20px 50px">
             ...
             <dl>
                ...
                注意事项：<br>
                1、所指定的节点与目标节点必须是属于同一模块。<br> 
                2、指定的节点和目标节点必须都是叶节点。<br> 
                3、所有操作不可逆，请慎重操作。<br> 
                4、合并后您所指定的节点（或者包括其下属节点）将被删除，所有内容信息将转移到目标节点中。 
                </dd>
             </dl>
        ...
        <div class="Submit">
            ...
            <asp:Button ID="btnSave" class="subButton" runat="server" Text="<%$Resources:Common,Save %>"  OnClientClick="selfconfirm({msg:'确定要合并栏目吗？',fn:function(data){setAction1(data)}});return false;"/>
