<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModuleCount.aspx.cs" Inherits="KingTop.WEB.SysAdmin.SysManage.ModuleCount" %>
...
<body>
    <div class="container" id="_ListInfoListTable">
        ...
        <h4>
            位置： <a href="TemplateList.aspx">扩展应用</a> > <span style="color: Blue">流量统计</span>
        </h4>
        <div id="searchContainer">
            <ul>              
                <li><a href="ModuleCount.aspx">显示全部</a></li> <li>|</li>
                <li><a href="ModuleCount.aspx?type=1">最近一周</a> </li><li>|</li>
                <li><a href="ModuleCount.aspx?type=2">最近一月</a> </li><li>|</li>
                <li><a href="ModuleCount.aspx?type=3">最近一年</a> </li>
            </ul>
            <br />
        </div>
