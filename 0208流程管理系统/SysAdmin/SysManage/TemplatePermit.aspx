<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TemplatePermit.aspx.cs"
    Inherits="AllPower.WEB.SysAdmin.SysManage.TemplatePermit" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">       
        ...
        function btnSaveOnClick() {
            ...
            strUserPk = document.getElementById("txtTemplate").value;
            if (strUserPk.length == 0) {
                alert({ msg: '未发现模板！', title: '提示信息' });
                return;
            }
            if (objChks.length == 0) {
            ...
            strXml = xmlLoadXMLHttp(null, "TemplatePermit.aspx?TemplateID=" + strUserPk + "&NodeID=" + NodeId, null, strXml, null);

            alert({ msg: '修改模板权限成功！', title: '提示信息' });
            return strXml;
        }
...
<body>
    ...
    <div>
        ...
        <div class="function">
            <input id="txtTemplate" type="hidden" runat="server" />
            <input id="txtNodeId" type="hidden" runat="server" />
            <input id="btnOK" runat="server" type="button" Class="subButton" value="<%$Resources:Common,Save %>"
