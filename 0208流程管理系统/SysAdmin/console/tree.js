...
function createTree(arrName, startNode, openNode) {
    ...
    if (nodes.length > 0) {
        ...
        if (startNode != 0) {
            ...
            document.write("<a href=\"" + nodeValues[3] + "\" target='frameRight' onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\"><img src=\"img/folderopen.gif\" align=\"absbottom\" alt=\"\" />" + nodeValues[2] + "</a><br />");
...
function addNode(parentNode, recursedNodes) {
    for (var i = 0; i < nodes.length; i++) {
        ...
        if (nodeValues[1] == parentNode) {
            ...
            // Start link
            document.write("<a href=\"" + nodeValues[3] + "\" target='frameRight' onmouseover=\"window.status='" + nodeValues[2] + "';return true;\" onmouseout=\"window.status=' ';return true;\">");
            ...
            if (hcn) {
                ...
                if (i == 0) {
                    document.getElementById("div" + nodeValues[0]).style.display = "block";
                }
            }
            if (strLength > 20) {
                isShowScrollX = 1;
