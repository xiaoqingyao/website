...
namespace KingTop.Web.Admin
{
    public partial class AdvertisementConfigEdit : AdminPage
    {
        ...
        KingTop.Model.Content.AdvertisementConfig modelAdvertisementConfig;
        BLL.Content.AdvertisementConfig bllAdvertisementConfig = new KingTop.BLL.Content.AdvertisementConfig();
        #endregion
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            modelAdvertisementConfig = new KingTop.Model.Content.AdvertisementConfig();
            ModelSaveOrUpdate();
