...
namespace KingTop.Web.Admin
{
    ...
    {
        KingTop.Model.Content.Advertisement modelAdvertisement;
        BLL.Content.Advertisement bllAdvertisement = new KingTop.BLL.Content.Advertisement();
        ...
        private void PageInit()
        {
            ...
            BLL.Content.Advertising bllAdvertising = new KingTop.BLL.Content.Advertising();
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            modelAdvertisement = new KingTop.Model.Content.Advertisement();
            ModelSaveOrUpdate();
