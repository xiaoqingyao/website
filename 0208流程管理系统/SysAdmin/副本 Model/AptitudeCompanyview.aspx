...
<div id="panel"><dl><dt>资质等级：</dt><dd id="K_U_AptitudeCompany_AptitudeLevel"><%=hsFieldValue["AptitudeLevel"]%></dd></dl><dl><dt>企业名称：</dt><dd id="K_U_AptitudeCompany_CompanyID"><%=hsFieldValue["CompanyID"]%></dd></dl></div>
<asp:HiddenField Value="K_U_AptitudeCompany" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000007425925" runat="server" />
</div>
