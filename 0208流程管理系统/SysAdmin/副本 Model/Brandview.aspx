...
<div id="panel"><dl><dt>品牌名称：</dt><dd id="K_G_Brand_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>品牌网址：</dt><dd id="K_G_Brand_Url"><%=hsFieldValue["Url"]%></dd></dl><dl><dt>品牌LOGO：</dt><dd id="K_G_Brand_Logo"><%=hsFieldValue["Logo"]%></dd></dl><dl><dt>品牌描述：</dt><dd id="K_G_Brand_Description"><%=hsFieldValue["Description"]%></dd></dl><dl><dt>是否显示：</dt><dd id="K_G_Brand_IsDisplay"><%=ctrManageView.ParseFieldValueToText("100011297673437",hsFieldValue["IsDisplay"])%></dd></dl></div>
