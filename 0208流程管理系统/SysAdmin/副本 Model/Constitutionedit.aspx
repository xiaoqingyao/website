...
<div id="panel"><dl><dt>章程标题</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["ConTitle"]%>" style="width:300px;"  maxlength="30" name="ConTitle" id="ConTitle" /></dd></dl><%KingTop.Config.UploadConfig uploadobj = KingTop.Config.Upload.GetConfig(GetUploadImgPath); %><dl><dt>章程内容</dt><dd><textarea  id="ConContent" name="ConContent"><%=hsFieldValue["ConContent"]%></textarea><script type="text/javascript">    var ConContent$$ckeditor$$obj = CKEDITOR.replace('ConContent', { language: '<%=Resources.Model.DateLang%>', height: '300px',width:'650px' }); </script></dd></dl></div>
