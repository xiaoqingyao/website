...
<div id="panel"><dl><dt>章程标题：</dt><dd id="K_U_Constitution_ConTitle"><%=hsFieldValue["ConTitle"]%></dd></dl><dl><dt>章程内容：</dt><dd id="K_U_Constitution_ConContent"><%=hsFieldValue["ConContent"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Constitution" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000001628125" runat="server" />
</div>
