...
<div id="panel"><dl><dt>Part Number</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["Title"]%>" style="width:180px;"  maxlength="512" name="Title" id="Title" /></dd></dl><dl><dt>Image</dt><dd><input   type="text" value="<%=hsFieldValue["ImageUrl"]%>" style="width:150px;"  maxlength="" name="ImageUrl" id="ImageUrl" /> <input type='button' onclick="InputImages('theForm', 'ImageUrl', 1, 'jpeg|jpg|gif', 4096, '',125,125)" value = '上传图片' /></dd></dl><dl><dt>Data Rate</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["Data_Rate"]%>" style="width:180px;"  maxlength="128" name="Data_Rate" id="Data_Rate" /></dd></dl><dl><dt>Reach</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["Reach"]%>" style="width:180px;"  maxlength="128" name="Reach" id="Reach" /></dd></dl><dl><dt>LD</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["LD"]%>" style="width:180px;"  maxlength="128" name="LD" id="LD" /></dd></dl><dl><dt>PD</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["PD"]%>" style="width:180px;"  maxlength="128" name="PD" id="PD" /></dd></dl><dl><dt>Operating Case Temperature</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["Operating_Case_Temperature"]%>" style="width:180px;"  maxlength="128" name="Operating_Case_Temperature" id="Operating_Case_Temperature" /></dd></dl><%KingTop.Config.UploadConfig uploadobj = KingTop.Config.Upload.GetConfig(GetUploadImgPath); %><dl><dt>Brief</dt><dd><textarea  id="Brief" name="Brief"><%=hsFieldValue["Brief"]%></textarea><script type="text/javascript">var Brief$$ckeditor$$obj = CKEDITOR.replace('Brief', { linkUploadAllowedExtensions: '<%=uploadobj.UploadFilesType %>', nodeId: 1,language:'<%=Resources.Model.DateLang%>', watermark: false, height: '260px', toolbar: 'ContentFull', modelId: 1, flashUploadAllowedExtensions: '<%=uploadobj.UploadMediaType %>', width: '690px', imageUploadAllowedExtensions: '<%=uploadobj.UploadImageType %>', skin: 'blue', thumbnail: false, fileRecord: true, fieldName: 'Content', wordPic: false, flashUpload: true, imageUpload: true, linkUpload: true, foreground: false, moduleName: '' }); </script></dd></dl></div>
