<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ControlFormTemplate.aspx.cs" Inherits="KingTop.Web.Admin.ControlFormTemplate" %>
...
<body>
    ...
    <table id="_ListInfoListTable" style="width: 100%;" border="0">  
         <tr><td>ADF</td><td><%=dr!=null?dr["ADFEEEFFFF"].ToString():"" %></td></tr>
...
<tr><td></td><td><asp:Button ID="btnReply" runat="server" Text="回复" 
   ...
   <asp:HiddenField ID="hdnModelID" Value="000000000132380" runat="server" /><asp:HiddenField ID="hdnTableName" Value="K_F_messbox" runat="server" /><asp:HiddenField ID="hdnCustomCol" Value="" runat="server" />   <asp:HiddenField ID="hdnForignTableCol" value="" runat="server" /><asp:HiddenField ID="hdnShowCol" value="K_F_messbox.ADFEEEFFFF" runat="server" />   
   </form>    
</body>
</html>
