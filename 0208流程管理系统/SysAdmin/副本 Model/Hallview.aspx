...
<div id="panel"><dl><dt>展厅名称：</dt><dd id="K_U_Hall_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>展厅大图：</dt><dd id="K_U_Hall_BigImg"><%=hsFieldValue["BigImg"]%></dd></dl><dl><dt>展厅小图：</dt><dd id="K_U_Hall_SmallImg"><%=hsFieldValue["SmallImg"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Hall" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000030689626" runat="server" />
</div>
