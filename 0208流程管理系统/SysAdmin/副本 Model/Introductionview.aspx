...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Introduction_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>内容：</dt><dd id="K_U_Introduction_Context"><%=hsFieldValue["Context"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Introduction" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000010973437" runat="server" />
</div>
