...
<div id="panel"><dl><dt>增发年度：</dt><dd id="K_U_Issuing_IssuingYear"><%=hsFieldValue["IssuingYear"]%></dd></dl><dl><dt>增发方案：</dt><dd id="K_U_Issuing_IssuingPlan"><%=hsFieldValue["IssuingPlan"]%></dd></dl></div>
<asp:HiddenField Value="K_U_Issuing" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000041096255" runat="server" />
</div>
