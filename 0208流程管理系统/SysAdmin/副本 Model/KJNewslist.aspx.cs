...
{
    public partial class KJNewslist : System.Web.UI.Page
    {
        ...
        {
            string sql = "delete from K_U_KJNews where ID='" + id + "'";
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(IdList))
            {
                ...
                {
                    string sql = "delete from K_U_KJNews where ID=" + sid[i];
        ...
        {
            Response.Redirect("KJNewsedit.aspx?action=add&NodeCode=" + nodecode);
        }
        ...
        protected void txtOrders_TextChanged(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < rptMember.Items.Count; i++)
            {
                ...
                sql = "update K_U_KJNews set Orders=" + labOrders + " where ID='" + Id + "'";
