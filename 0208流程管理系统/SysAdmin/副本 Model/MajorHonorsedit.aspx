...
<div id="panel"><dl><dt>年度</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["Years"]%>" style="width:100px;"  maxlength="30" name="Years" id="Years" /></dd></dl><dl><dt>颁发单位</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["LicenceUnit"]%>" style="width:250px;"  maxlength="200" name="LicenceUnit" id="LicenceUnit" /></dd></dl><dl><dt>荣誉名称</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["HonorsName"]%>" style="width:250px;"  maxlength="200" name="HonorsName" id="HonorsName" /></dd></dl></div>
<div class="Submit" id="HQB_Operation_Button">
 <asp:Button ID="btnModelManageEdit" OnClick="Edit"  runat="server" />
 <input type="button" value="返回" onclick="back()" />
 </div>
</div>
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_MajorHonors" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Years||1,LicenceUnit||1,HonorsName||1," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000000957812" runat="server" /><input type="hidden" id="hdnModelAlias" value="主要荣誉" name="hdnModelAlias"/> 
