...
<div id="panel"><dl><dt>门诊时间：</dt><dd id="K_U_MenZhenDate_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_U_MenZhenDate" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000026429687" runat="server" />
</div>
