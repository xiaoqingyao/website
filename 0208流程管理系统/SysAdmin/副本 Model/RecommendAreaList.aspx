<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecommendAreaList.aspx.cs" EnableEventValidation="false" Inherits="KingTop.WEB.SysAdmin.Model.RecommendAreaList" %>
                    ...
                    <li style="width: 40px;">
                        <asp:LinkButton ID="LinkButton2" OnCommand="SetIsEnable" CommandArgument='<%#Eval("ID").ToString() + "|" + Eval("IsEnable").ToString()%>'
                            CommandName="STATE" runat="server">
                                <%#KingTop.Common.Utils.ParseState(Eval("IsEnable"),"状态不明")%>
                        </asp:LinkButton>
