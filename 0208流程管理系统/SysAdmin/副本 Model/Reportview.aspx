...
<div id="panel"><dl><dt>期数：</dt><dd id="K_U_Report_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>图片：</dt><dd id="K_U_Report_Image"><%=hsFieldValue["Image"]%></dd></dl><dl><dt>发布日期：</dt><dd id="K_U_Report_PubDate"><%=hsFieldValue["PubDate"]%></dd></dl></div>
