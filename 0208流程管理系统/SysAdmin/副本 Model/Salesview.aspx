...
<div id="panel"><dl><dt>标题：</dt><dd id="K_U_Sales_Title"><%=hsFieldValue["Title"]%></dd></dl><dl><dt>联系地址：</dt><dd id="K_U_Sales_ContactAddr"><%=hsFieldValue["ContactAddr"]%></dd></dl><dl><dt>小图：</dt><dd id="K_U_Sales_SmallImg"><%=hsFieldValue["SmallImg"]%></dd></dl><dl><dt>省份：</dt><dd id="K_U_Sales_city"><%=hsFieldValue["city"]%></dd></dl></div>
