<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VoteList.aspx.cs" Inherits="KingTop.Web.Admin.VoteList"
        ...
        <asp:Repeater ID="rptModelFileGroup" runat="server">
            <ItemTemplate>
                <ul class="ulheader ulbody">
                    ...
                    <li style="width: 3%">
                        <%#KingTop.Common.Utils.ParseState(Convert.ToBoolean(Eval("IsEnable")),Resources.Common.ON) %></li>
                    <li style="width: 30%">
