...
<div class="container"id="_ListInfoListTable">
  <h4>位置： <%GetPageNav(NodeCode);%></h4>
    ...
    <div class="function" style="text-align:left" id="HQB_Model_ListLink"><a href="?Action={s}{(IsCommend)(=)(1)}">推荐</a><a href="?Action={s}{(IsCommend)(=)(0)}">未推荐</a><asp:Repeater runat="server" ID="rptFlowStep"><ItemTemplate><a href="?StepID=<%#Eval("StepID") %>" target="_self"><%#Eval("StepName") %></a></ItemTemplate></asp:Repeater></div>
