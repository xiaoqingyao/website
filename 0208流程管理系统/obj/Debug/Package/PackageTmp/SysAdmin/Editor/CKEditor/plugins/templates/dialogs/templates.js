...
(function() {
    ...
    b = 'cke' + CKEDITOR.tools.getNextNumber();
    function c(f, g) {
        var h = a.getById(b);
        h.setHtml('');
        for (var i = 0; i < g.length; i++) {
            var j = CKEDITOR.getTemplates(g[i]),
            k = j.imagesPath,
            l = j.templates;
    ...
    function e(f, g) {
        ...
        i = h.getValueOf('selectTpl', 'chkInsertOpt');
        if (i) f.setData(g);
        else f.insertHtml(g);
        h.hide();
    };
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    },
                    {
                        ...
                        onShow: function() {
                            CKEDITOR.loadTemplates(f.config.templates_files,
                function() {
