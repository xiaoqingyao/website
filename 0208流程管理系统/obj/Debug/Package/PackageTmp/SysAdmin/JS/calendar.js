...
function mOvr(thisObj, v) {
    ...
    if (sObj.html() != '') {
        ...
        arr.push('<div style="width:95%; height:70px; margin-top:10px; padding-top:0px; border-top:1px solid #CCCCCC; margin-left:auto; margin-right:auto;">' + jy + '</div>');
        ...
        $("#details").css({ "top": t, "left": l,"z-index":99999 }).show();
