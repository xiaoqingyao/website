                ...
                case "remind":
                    {
                        ...
                        {
                            if (arr4["_fc" + i] != undefined && arr4["_fc" + i] == this.trigger[0].innerText) {
                                $(".tip_title").html(this.trigger[0].innerText);
                                $("#tip_time").html(arr3["_fc" + i]);
                                $(".tip_content").html(arr1["_fc" + i]);
                                break;
                            }
                        }
                        strRemind = $("#tips").html();
                        //                        alert(this.trigger[0].innerText);
