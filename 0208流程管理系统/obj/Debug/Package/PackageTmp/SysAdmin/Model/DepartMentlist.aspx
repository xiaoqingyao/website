<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DepartMentlist.aspx.cs" Inherits="AllPower.WEB.SysAdmin.Model.DepartMentlist" %>
         ...
         onitemcommand="rptMember_ItemCommand">
            <ItemTemplate>
               <ul class="ulheader ulbody">
                ...
                第<asp:Label ID="lblCurrentPage" CssClass="pagenum3" runat="server" Text="1"></asp:Label>页/共<asp:Label
