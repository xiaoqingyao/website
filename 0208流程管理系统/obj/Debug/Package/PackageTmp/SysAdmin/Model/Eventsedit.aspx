...
<div id="panel"><dl><dt>标题</dt><dd><textarea style="height:100px;width:380px;"   class="validate[optional]"  id="Title"  name="Title"><%=hsFieldValue["Title"]%></textarea></dd></dl></div>
<div class="Submit" id="HQB_Operation_Button">
 <asp:Button ID="btnModelManageEdit" OnClick="Edit"  runat="server" />
 <input type="button" value="返回" onclick="back()" />
 </div>
</div>
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_Events" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Title||2," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000007434375" runat="server" /><input type="hidden" id="hdnModelAlias" value="大事记" name="hdnModelAlias"/> 
