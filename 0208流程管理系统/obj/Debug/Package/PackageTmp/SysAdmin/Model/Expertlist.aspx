<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Expertlist.aspx.cs" Inherits="AllPower.WEB.SysAdmin.Model.Expertlist" %>
...
<div class="container">
    ...
    <ul class="ulheader">
        ...
        <li style="width:60px;">专家名字</li>
        <li style="width:120px;">所属科室</li>
        <li style="width:50px;">性别</li>
        <li style="width:100px;">门诊选择</li>
        <li style="width:150px;">人才类型</li>
            ...
            <ItemTemplate>
               <ul class="ulheader ulbody">
                <li style="width:5%;">
                    ...
                    <a href="Expertedit.aspx?action=edit&ID=<%#Eval("ID") %>&NodeCode=<%=nodecode%>">修改</a>&nbsp;&nbsp;
