<%@ Page Language="C#" AutoEventWireup="true"  Inherits="AllPower.Web.Admin.ControlFormEdit" %>
...
<form id='theForm' runat='server'><asp:HiddenField ID='hidModelId' runat='server' Value='000000000279398' />

<%AllPower.BLL.Content.ModelField  bllModel = new AllPower.BLL.Content.ModelField();
