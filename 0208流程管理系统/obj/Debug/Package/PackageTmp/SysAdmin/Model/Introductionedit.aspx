...
<div id="panel"><dl><dt>标题</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["Title"]%>" style="width:200px;"  maxlength="100" name="Title" id="Title" /></dd></dl><%AllPower.Config.UploadConfig uploadobj = AllPower.Config.Upload.GetConfig(GetUploadImgPath); %><dl><dt>内容</dt><dd><textarea  id="Context" name="Context"><%=hsFieldValue["Context"]%></textarea><script type="text/javascript">    var Context$$ckeditor$$obj = CKEDITOR.replace('Context', { language: '<%=Resources.Model.DateLang%>', height: '300px',width:'650px' }); </script></dd></dl></div>
<div class="Submit" id="HQB_Operation_Button">
 <asp:Button ID="btnModelManageEdit" OnClick="Edit"  runat="server" />
 <input type="button" value="返回" onclick="back()" />
 </div>
</div>
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_Introduction" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Title||1,Context||3," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000010973437" runat="server" /><input type="hidden" id="hdnModelAlias" value="公司资源简介模型" name="hdnModelAlias"/> 
