...
<div id="panel"><dl><dt>标题：</dt><dd id="K_F_ARTICLE_Title"><%=hsFieldValue["Title"]%></dd></dl></div>
<asp:HiddenField Value="K_F_ARTICLE" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000034857722" runat="server" />
</div>
