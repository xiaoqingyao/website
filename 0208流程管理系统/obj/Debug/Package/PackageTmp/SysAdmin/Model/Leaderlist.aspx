...
<div class="container"id="_ListInfoListTable">
  <h4>位置： <%GetPageNav(NodeCode);%></h4>
      ...
      <div id="searchContainer">
        <ul>
        <li>姓名</li><li><input   type="text" value="" style="width:200px;"  maxlength="300" name="Title" id="Title" /></li><li>电话</li><li><input   type="text" value="" style="width:200px;"  maxlength="300" name="Tel" id="Tel" /></li>
   ...
   <asp:HiddenField ID="hdnNotSearchField" runat="server" value="" /><asp:HiddenField ID="hdnBackDeliverUrlParam" runat="server" value="NodeCode"  /> <asp:HiddenField ID="hdnModelID" Value="100000019446872" runat="server" /><asp:HiddenField ID="hdnTableName" Value="K_U_Leader" runat="server" />  <asp:HiddenField ID="hdnDeliverAndSearchUrlParam" runat="server"  Value=""/> <input type="hidden" value="" id="HQB_Model_DeliverUrlParam" /><asp:HiddenField ID="hdnCustomCol" Value="" runat="server" />   <asp:HiddenField ID="hdnForignTableCol" value="" runat="server" /><asp:HiddenField ID="hdnShowCol" value="K_U_Leader.ID,K_U_Leader.FlowState,K_U_Leader.Title,K_U_Leader.Tel,K_U_Leader.Email,K_U_Leader.Orders" runat="server" />
