<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModelFieldGroupList.aspx.cs"
    Inherits="AllPower.Web.Admin.ModelFieldGroupList" %>
                ...
                <ul class="ulheader ulbody">
                    ...
                    <li style="width: 30%">
                        ...
                        <asp:LinkButton ID="lnkbState" CssClass="abtn" OnCommand="lbtnEnable_Click" CommandArgument='<%#Eval("id")+"|"+Eval("IsEnable") %>'
                            runat="server" Text='<%#AllPower.Common.Utils.ParseState(!Convert.ToBoolean(Eval("IsEnable")),Resources.Common.ON) %>'></asp:LinkButton>
                    </li>
                </ul>
            </ItemTemplate>
        </asp:Repeater>
