<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModelFieldList.aspx.cs"
    Inherits="AllPower.Web.Admin.ModelFieldList" %>
            ...
            <ItemTemplate>
                <ul class="ulheader ulbody">
                    ...
                    <li style="width: 5%;" style="color: red">
                        <%# AllPower.Common.Utils.ParseModelFieldState(Eval("IsSystemFiierd"),"") %></li>
                    <li style="width: 5%;" style="color: red">
                        <%# AllPower.Common.Utils.ParseModelFieldState(Eval("IsRequired"), "")%></li>
                    <li style="width: 5%;" style="color: red">
                        <%# AllPower.Common.Utils.ParseModelFieldState(Eval("IsSearch"), "")%></li>
                    <li style="width: 5%;" style="color: red">
                        <%# AllPower.Common.Utils.ParseModelFieldState(Eval("ListIsOrder"), "")%></li>
                    <li style="width: 5%;" style="color: red">
                        <%# AllPower.Common.Utils.ParseModelFieldState(Eval("IsListEnable"), "")%></li>
                    <li style="width: 5%;" style="color: red">
                        <%# AllPower.Common.Utils.ParseModelFieldState(Eval("IsEnable"), "")%></li>
                    <li width="20%">
                        ...
                        <asp:LinkButton ID="lbtnEnable" runat="server" Text='<%#AllPower.Common.Utils.ParseState(!Convert.ToBoolean(Eval("IsEnable")),Resources.Common.ON) %>'
