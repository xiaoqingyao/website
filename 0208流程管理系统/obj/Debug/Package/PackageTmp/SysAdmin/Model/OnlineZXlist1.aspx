<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OnlineZXlist.aspx.cs" Inherits="AllPower.WEB.SysAdmin.Model.OnlineZXlist" %>
...
<div class="container">
     <h4>位置： <a href="#">系统管理</a><a> &gt;</a> <a href="#">科室导航</a><a> &gt;</a> <span class="breadcrumb_current" > <a href="#">在线咨询</a></span> </h4>
    ...
    <ul class="ulheader">
        ...
        <li style="width:250px;">提问标题</li>
        <li style="width:150px;">所属科室</li>
        <li style="width:100px;">提交日期</li>
        <li style="width:60px;">审核状态</li>
            ...
            <ItemTemplate>
               <ul class="ulheader ulbody">
                <li style="width:5%;">
                    ...
                    <li style="width:250px;"><%#Eval("Title")%></li>
                    <li style="width:150px;"><%#Eval("DepartMent")%></li>
                    <li style="width:100px;"><%#Eval("AddDate")%></li>
                    <li style="width:60px;"><%#Eval("FlowState").ToString() == "3" ? "待审核" : "终审通过"%></li>
                    <li style="width:60px;">
                    ...
                    <a href="OnlineZXedit.aspx?action=edit&ID=<%#Eval("ID") %>&NodeCode=<%#Eval("NodeCode") %>">修改</a>&nbsp;&nbsp;
                ...
                跳转到第<%--<asp:TextBox ID="lblPage" runat="server" Style="ime-mode: disabled; text-align: center"
                    Height="17px" MaxLength="8" Width="30px"></asp:TextBox>--%>
