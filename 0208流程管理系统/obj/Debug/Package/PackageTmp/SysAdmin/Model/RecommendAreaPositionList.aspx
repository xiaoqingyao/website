<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RecommendAreaPositionList.aspx.cs"  EnableEventValidation="false"   Inherits="AllPower.WEB.SysAdmin.Model.RecommendAreaPositionList" %>
        ...
        <asp:Repeater ID="rptRecommendAreaPosition" runat="server">
            <ItemTemplate>
                <ul class="ulheader ulbody">
                    ...
                    <li style="width: 40px;"><asp:LinkButton ID="LinkButton2" OnCommand="SetIsEnable" CommandArgument='<%#Eval("ID").ToString() + "|" + Eval("IsEnable").ToString()%>' CommandName="STATE" runat="server"><%#AllPower.Common.Utils.ParseState(Eval("IsEnable"),"状态不明")%></asp:LinkButton></li>
