...
<div id="panel"><dl><dt>图片标题</dt><dd><input  class="validate[optional]"  type="text" value="<%=hsFieldValue["Title"]%>" style="width:180px;"  maxlength="100" name="Title" id="Title" /></dd></dl><dl><dt>图片</dt><dd><input id=""  type="hidden" value="<%=hsFieldValue[""]%>" id="Image"  name="" /><input   type="text" value="<%=hsFieldValue["Image"]%>" style="width:180px;"  maxlength="" name="Image" id="Image" /> <input type='button' onclick="InputImages('theForm', 'Image', 1, '', 10240, '',190,130)" value = '上传图片' /></dd></dl></div>
<div class="Submit" id="HQB_Operation_Button">
 <asp:Button ID="btnModelManageEdit" OnClick="Edit"  runat="server" />
 <input type="button" value="返回" onclick="back()" />
 </div>
</div>
 <asp:HiddenField ID="hdnFieldFromUrlParamValue" runat="server" Value="" /><asp:hiddenfield ID="hdnNodeCode" runat="server"/><asp:HiddenField Value="K_U_ResourcesImage" ID="hdnTableName" runat="server" /><asp:HiddenField Value="Title||1,Image||11,|0|8," ID="hdnFieldValue" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000010946252" runat="server" /><input type="hidden" id="hdnModelAlias" value="公司资源图片模型" name="hdnModelAlias"/> 
