<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReviewFlowEdit.aspx.cs"
    Inherits="AllPower.Web.Admin.ReviewFlowEdit" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        window.onload = function() {
            if (type > -1) {
                showEditMessage("审核流程", "ReviewFlowList.aspx<%=StrPageParams %>", "ReviewFlowEdit.aspx?NodeCode=<%=NodeCode %>", "ReviewFlowEdit.aspx?NodeCode=<%=NodeCode %>&action=edit&id=<%=ID %>");
            }
        }
    </script>
...
<body>
    ...
    <div class="container">
        <h4>
            位置： <a href="#">系统管理</a> > <a href="ReviewFlowList.aspx?NodeCode=<%=NodeCode %>">">审核流程管理</a>
            <span style="color: Blue">添加流程</span>
        </h4>
        <dl>
            <dt>
        ...
        <div class="Submit">
            ...
            &nbsp;<input type="button" class="subButton" name="Submit422" value="<%= Resources.Common.Back %>"
                onclick='location.href="ReviewFlowList.aspx<%=StrPageParams %>";'>
        </div>
    </div>
    </form>
</body>
