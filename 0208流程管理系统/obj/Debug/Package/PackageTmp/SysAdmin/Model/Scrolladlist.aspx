...
<div class="container"id="_ListInfoListTable">
  <h4>位置： <%GetPageNav(NodeCode);%></h4>
      ...
      <div id="searchContainer">
        <ul>
        <li>名称</li><li><input   type="text" value="" style="width:100px;"  maxlength="300" name="Title" id="Title" /></li>
