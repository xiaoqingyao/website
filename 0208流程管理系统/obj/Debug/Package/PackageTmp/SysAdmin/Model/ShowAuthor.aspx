<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowAuthor.aspx.cs" Inherits="AllPower.WEB.SysAdmin.Model.ShowAuthor" %>
        ...
        <div class="antables">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" id="AuthorInfoList">
              ...
              <tr onclick="SetAuthor(this,'|','Author')">
                <td><%#Eval("Name") %></td>
                <td><%# AllPower.Common.Utils.ParseGender(Eval("Gender"),"保密") %></td>
