...
<div id="panel"><dl><dt>用户名：</dt><dd id="K_U_user_UserName"><%=hsFieldValue["UserName"]%></dd></dl><dl><dt>密码：</dt><dd id="K_U_user_pwd"><%=hsFieldValue["pwd"]%></dd></dl><dl><dt>邮箱：</dt><dd id="K_U_user_email"><%=hsFieldValue["email"]%></dd></dl></div>
<asp:HiddenField Value="K_U_user" ID="hdnTableName" runat="server" /><asp:HiddenField ID="hdnModelID" Value="100000039789626" runat="server" />
</div>
