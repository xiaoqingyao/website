<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false" CodeBehind="ColumnEdit.aspx.cs" Inherits="AllPower.WEB.SysAdmin.SysManage.ColumnEdit" %>
    ...
    <script type="text/javascript">
        ...
        function showMessage() {
            ...
            if (type == 0) {
                ...
                msgContent += "<a href='ColumnEdit.aspx?<%=AllPower.Common.Utils.GetUrlParams() %>' style='color:red'>继续添加</a> | ";
                ...
                msgContent += "<a href='ColumnEdit.aspx?<%=AllPower.Common.Utils.GetUrlParams() %>' style='color:red'>继续修改</a>";
                if (editSelfMenuUrl != "") {
    ...
    <div class="container">
        ...
        <div id="con">
            <ul id="tags">
                ...
                <li><a href="javascript:;">模板选项</a></li>
            ...
            <div id="panel">
                ...
                <fieldset>
                    ...
                    <dl>
                        <dt>栏目目录名：</dt>
                        <dd><asp:TextBox ID="txtNodeDir" runat="server" class="validate[required,custom[onlyLetter],length[0,64]] text-input"></asp:TextBox> <font color=red>*</font></dd>
                    </dl>
                    <dl>
                 ...
                 <fieldset style="display: none;">
                    ...
                    <dl style="display:none">
                        <dt>子域名地址：</dt>
                        <dd><asp:TextBox ID="txtSubDomain" runat="server"></asp:TextBox>(例如：http://www.360hqb.com/ )</dd>
                    </dl>
                    <dl>
                        <dt>栏目Banner：</dt>
            ...
            <div class="Submit">
                ...
                <asp:Button ID="btnEdit" runat="server" CssClass="subButton" Text="<%$Resources:Common,Add %>" OnClientClick="changeTabOne();" OnClick="btnEdit_Click" />
