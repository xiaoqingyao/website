<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MsgReceiveList.aspx.cs" Inherits="AllPower.WEB.SysAdmin.SysManage.MsgReceiveList" %>
...
<body>
    ...
    <div class="container">
        <h4>
            位置： <a href="#">我的工作台</a> &gt; <span class="breadcrumb_current"> 我接收的短信息</span>
        </h4>
        <ul id="tags">
        	<li class="selectTag"><a href="MsgReceiveList.aspx">己接收的短消息</a> </li>
        ...
        <ul class="ulheader">
            ...
            <li style="width: 6%;text-align:center">发送人</li>
            <li style="width: 60%;text-align:center">内容</li>
            ...
            <ItemTemplate>
                <ul class="ulheader ulbody">
                    ...
                    <li style="width: 6%;text-align:center">
                        <%#GetUserName(Eval("SendUID").ToString(),Eval("UserName").ToString ())%></li>
                    <li style="width: 60%"><a href='#' id="Title<%# Eval("ID")%>"><%#AllPower.Common.Utils.DropHtmlTag(Eval("Content").ToString())%></a></li>
                    ...
                    <li style="width: 13%">                        
                       <asp:LinkButton ID="lnkbDelete" cssclass="abtn" runat="server" OnCommand="MsgReceiveList_Del"
                        ...
                        <a class="abtn" href='MsgAdd.aspx?NodeCode=<%=NodeCode %>&SendUID=<%#Eval("SendUID")%>'>回复</a> 
                   </li>
                </ul>
            </ItemTemplate>
        </asp:Repeater>
