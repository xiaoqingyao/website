<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LableSystemEdit.aspx.cs" EnableEventValidation="false"
    Inherits="AllPower.WEB.SysAdmin.Template.LableSystemEdit" ValidateRequest="false" %>
<%--================================================================
      ...
      <script type="text/javascript">
        ...
        window.onload = function() {
            if (type > -1) {
                ...
                var addUrl = "LableStaticEdit.aspx?action=NEW&NodeCode=<%=NodeCode%>&IsSystem=0";
                var updateUrl = "?Action=EDIT&NodeCode=<%=NodeCode%>&IsSystem=0&id=" + id;
...
<body>
    ...
    <div class="container">
        <h4>
            位置：<a href="TemplateList.aspx">模板管理</a> > <a href="LableList.aspx">标签管理</a>
            > <span style="color: Blue">添加/修改静态标签</span></h4>
        <br />
        <div id="panel">
            <dl>                
                    <dt>标签名称：</dt>
            ...
            <dl id="webProject">
                ...
                <dt></dt>
                <dd>
                    <input type="button" class="abtn" value="站点地址" onclick="setContent('{$SiteUrl}')" />
            ...
            <dl>
                ...
                <dd>
                   ...
                   <asp:TextBox runat="server" ID="txtLableContent" TextMode="MultiLine"  Width="560" Wrap="false"
                        CssClass="validate[required]" Height="250px"></asp:TextBox></dd>
            </dl>
            <dl>
                <dt>说明：</dt>
                <dd>
