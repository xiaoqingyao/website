<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="neatupload.aspx.cs" Inherits="AllPower.Web.Admin.neatupload" %>
    ...
    <div class="container">
        <div id="span1" runat="server" style=" padding:0; margin:0;">
            <dl id="Table2" style="display:none" >
                <dt><img src="../images/loading.gif" /></dt>
                <dd><%=Resources.Common.UploadMsg8%></dd>
            </dl>
	       <div id="Table1">
		        <dl>
		            <dt style="width:100px"><%=Resources.Common.UploadMsg2%>：</dt>
		            <dd>
                            <Upload:InputFile ID="InputFile1" runat="server" style="WIDTH:320px;HEIGHT:20px"  CssClass="botton" onkeydown="return false" oncontextmenu="return false" />
							</dd>
		        </dl>	
		        ...
		        <dl>
		            ...
		            <dd><asp:Label ID="lblMessage" runat="server" Text="Label"></asp:Label><br />2.<%=Resources.Common.UploadMsg5%><span id="spanSize" runat ="server"></span>M。</dd>
		        </dl>
        		
		        <div class="Submit">
		            <asp:Button ID="btnUpload" runat="server" Text='<%$Resources:Common,UploadSubmit%>' CssClass="AddBtn" OnClick="btnUpload_Click" OnClientClick="return checkData(this)" />
		            <input type="button" name="button1" value="<%=Resources.Common.UploadClose%>" class="AddBtn" onclick="parent.Closed();" />
		        </div>
            </div>
		</div>
