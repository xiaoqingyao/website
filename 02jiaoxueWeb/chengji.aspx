<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chengji.aspx.cs" Inherits="chengji" %>
                ...
                <td height="136" valign="top"><table id="Table8" width="676" height="136" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td width="676" height="34" background="qtimages/img_02_03_02_01.gif"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="14%" align="center" style="height: 15px"><span class="STYLE6">成绩反馈</span></td>
                        <td width="86%" style="height: 15px">&nbsp;</td>
                      </tr>
                    </table></td>
                  </tr>
                  <tr>
                    <td width="676" background="qtimages/img_02_03_02_02.gif" style="height: 119px" align="left">
                        学号：<asp:TextBox ID="bh" runat="server"></asp:TextBox>姓名：<asp:TextBox ID="mc" runat="server"></asp:TextBox>&nbsp;<asp:Button
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AllowSorting="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="xuehao" HeaderText="学号"></asp:BoundColumn>
                                <asp:BoundColumn DataField="xingming" HeaderText="姓名"></asp:BoundColumn>
                                <asp:BoundColumn DataField="kemu" HeaderText="科目"></asp:BoundColumn>
                                <asp:BoundColumn DataField="xuenian" HeaderText="学年"></asp:BoundColumn>
                                <asp:BoundColumn DataField="xueqi" HeaderText="学期"></asp:BoundColumn>
