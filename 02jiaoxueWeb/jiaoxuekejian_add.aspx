<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jiaoxuekejian_add.aspx.cs" Inherits="jiaoxuekejian_add" %>
...
<script language="javascript">
    ...
    function UpSuccess(filePath) {
        document.getElementById("wenjian").value = filePath;
    }
</script>
<body>
    <form id="Form1" method="post" runat="server">
        <table cellspacing="0" bordercolordark="#9cc7ef" cellpadding="4" width="100%" align="center"
            ...
            <tr bgcolor="#4296e7">
                <td colspan="2">
                    <div align="center"><font color="#ffffff">添加教学课件</font></div>
                </td>
            </tr>
                            ...
                            <asp:TextBox ID='mingcheng' Width='395px' runat='server'></asp:TextBox>*<asp:RequiredFieldValidator ID="RequiredFieldValidatormingcheng" runat="server" ControlToValidate="mingcheng" ErrorMessage="必填"></asp:RequiredFieldValidator><tr>
                                ...
                                <td width='79%'>
                                    <asp:TextBox ID='kecheng' runat='server'></asp:TextBox>*<asp:RequiredFieldValidator ID="RequiredFieldValidatorkecheng" runat="server" ControlToValidate="kecheng" ErrorMessage="必填"></asp:RequiredFieldValidator><tr>
                                        ...
                                        <td width='79%'>
                                            <asp:TextBox ID='wenjian' Width='395px' runat='server'></asp:TextBox>&nbsp;<a href="javaScript:OpenScript('hsgupfile.aspx?Result=wenjian',500,30)"><img src='Images/Upload.gif' width='30' height='16' border='0' align='absmiddle' /></a>*<asp:RequiredFieldValidator ID="RequiredFieldValidatorwenjian" runat="server" ControlToValidate="wenjian" ErrorMessage="必填"></asp:RequiredFieldValidator><tr>
