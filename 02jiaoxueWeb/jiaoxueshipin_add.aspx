<%@ Page Language="C#" AutoEventWireup="true" CodeFile="jiaoxueshipin_add.aspx.cs" Inherits="jiaoxueshipin_add" %>
...
<script language="javascript">
    ...
    function UpSuccess(filePath) {
        document.getElementById("shipinwenjian").value = filePath;
    }
</script>
<body>
    <form id="Form1" method="post" runat="server">
        <table cellspacing="0" bordercolordark="#9cc7ef" cellpadding="4" width="100%" align="center"
            ...
            <tr bgcolor="#4296e7">
                <td colspan="2">
                    <div align="center"><font color="#ffffff">添加教学视频</font></div>
                </td>
            </tr>
                            ...
                            <asp:TextBox ID='mingcheng' Width='395px' runat='server'></asp:TextBox>*<asp:RequiredFieldValidator ID="RequiredFieldValidatormingcheng" runat="server" ControlToValidate="mingcheng" ErrorMessage="必填"></asp:RequiredFieldValidator><tr>
                                ...
                                <td width='79%'>
                                    <asp:TextBox ID='kecheng' runat='server'></asp:TextBox>*<asp:RequiredFieldValidator ID="RequiredFieldValidatorkecheng" runat="server" ControlToValidate="kecheng" ErrorMessage="必填"></asp:RequiredFieldValidator><tr>
                                        <td nowrap width='30' style='width: 164px'><font face='宋体'>视频文件:</font></td>
                                        <td width='79%'>
                                            <asp:TextBox ID='shipinwenjian' Width='395px' runat='server'></asp:TextBox>&nbsp;<a href="javaScript:OpenScript('hsgupfile.aspx?Result=shipinwenjian',500,30)"><img src='Images/Upload.gif' width='30' height='16' border='0' align='absmiddle' /></a>*<asp:RequiredFieldValidator ID="RequiredFieldValidatorshipinwenjian" runat="server" ControlToValidate="shipinwenjian" ErrorMessage="必填"></asp:RequiredFieldValidator><tr>
