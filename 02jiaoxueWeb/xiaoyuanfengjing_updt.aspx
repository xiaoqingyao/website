<%@ Page Language="C#" AutoEventWireup="true" CodeFile="xiaoyuanfengjing_updt.aspx.cs" Inherits="xiaoyuanfengjing_updt" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" borderColorDark="#9cc7ef" cellPadding="4" width="100%" align="center"
				...
				<tr bgColor="#4296e7">
					<td colSpan="2">
						<div align="center"><font color="#ffffff">修改学员作品</font></div>
					</td>
				</tr>
