<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ziliaoxiazai_add.aspx.cs" Inherits="ziliaoxiazai_add" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" borderColorDark="#9cc7ef" cellPadding="4" width="100%" align="center"
				...
				<tr bgColor="#4296e7">
					<td colSpan="2">
						<div align="center"><font color="#ffffff">添加资料下载</font></div>
					</td>
				</tr>
				
			<tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>编号:</FONT></td><td width='79%'><asp:TextBox ID='bianhao' runat='server'></asp:TextBox>*<asp:RequiredFieldValidator ID="RequiredFieldValidatorbianhao" runat="server" ControlToValidate="bianhao" ErrorMessage="必填"></asp:RequiredFieldValidator><tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>名称:</FONT></td><td width='79%'><asp:TextBox ID='mingcheng' runat='server'></asp:TextBox>*<asp:RequiredFieldValidator ID="RequiredFieldValidatormingcheng" runat="server" ControlToValidate="mingcheng" ErrorMessage="必填"></asp:RequiredFieldValidator><tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>类型:</FONT></td><td width='79%'><asp:DropDownList ID='leixing' runat='server'></asp:DropDownList></td></tr><tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>简介:</FONT></td><td width='79%'><asp:TextBox ID='jianjie' Width='400px' Height='100px' TextMode='MultiLine' runat='server'></asp:TextBox></td></tr><tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>文件:</FONT></td><td width='79%'>
                <input id="UploadFile" runat="server" name="UploadFile" size="50" type="file" /></td></tr><tr><td noWrap width='30' style='WIDTH: 164px'><FONT face='宋体'>发布人:</FONT></td><td width='79%'><asp:TextBox ID='faburen' runat='server'></asp:TextBox></td></tr>
