<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AcountManager.aspx.cs" Inherits="UserManger_AcountManager" %>
...
<table cellpadding="0" cellspacing="0" style="width:100%;">
    <tr>
        <td colspan="1" style="height: 6px; width: 1188px;">
                        <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" OnClick="LinkButton1_Click">添加资金账户</asp:LinkButton></td>
    </tr>
    <tr>
                ...
                <tr>
                    <td style="text-align: left;" valign="top" align="left">
                        <asp:GridView ID="GvInfo" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="资金账户小类">
                                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                                    <ItemTemplate>
                                        <asp:Label ID="l1" runat="server" Text='<%# Bind("name") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                              <asp:TemplateField HeaderText="资金账户大类">
                                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                                    <ItemTemplate>
                                        <asp:Label ID="l2" runat="server" Text='<%# Bind("atype") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>  
                                <asp:TemplateField HeaderText="账户备注">
                                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                                    <ItemTemplate>
                                        <asp:Label ID="l4" runat="server" Text='<%# Bind("bz") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="修改">
                                 <ItemStyle HorizontalAlign="left" Width="50px" />
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "ModifyAccount.aspx?id="+Eval("id") %>'
