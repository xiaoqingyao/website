<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyAccount.aspx.cs" Inherits="UserManger_ModifyAccount" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom: 8px; margin-top: 8px;">
                <tr>
                    <td class='title' style="width: 1158px"><span>修改资金账户</span></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                                            ...
                                            <td style="text-align: left;" valign="top" align="left">
                                                <table border="0" cellpadding="0" cellspacing="0" class="text008" width="100%">
                                                    ...
                                                    <tr align="center" class="bg04">
                                                        ...
                                                        <td align="left">
                                                            <asp:DropDownList runat="server" ID="atype">
                                                    ...
                                                    <tr align="center" class="bg04">
                                                        <td align="right" height="35" style="width: 128px">币种：</td>
