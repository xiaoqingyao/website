    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom: 8px; margin-top: 8px;">
                <tr>
                    <td class='title'><span>修改借贷信息</span></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                    <td align="left">
                                            ...
                                            <td style="text-align: left;" valign="top" align="left">
                                                <table border="0" cellpadding="0" cellspacing="0" class="text008" width="100%">
                                                    <tr align="center" class="bg04">
                                                        <td align="right" style="width: 128px; height: 35px;">借款人：</td>
                                                    ...
                                                    <tr align="center" class="bg04">
                                                        <td align="right" height="35" style="width: 128px">
                                                            <asp:Label runat="server" ID="Label2">借贷日期：</asp:Label></td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtJksj" runat="server" onclick="WdatePicker()"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr align="center" class="bg04">
                                                        <td align="right" height="35" style="width: 128px">涉及金额：</td>
                                                        <td align="left">
                                                            <asp:TextBox ID="TxtMoney" runat="server"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr align="center" class="bg04">
                                                        <td align="right" height="35" style="width: 128px">借款类型：</td>
                                                        <td align="left">
                                                            <asp:DropDownList ID="DropDownList1" runat="server" Width="91px" Enabled="false">
                                                    ...
                                                    <tr align="center" class="bg04">
                                                        <td align="right" height="35" style="width: 128px">
                                                            <asp:Label runat="server" ID="Label4">收回/归还日期：</asp:Label></td>
                                                        <td align="left">
                                                    ...
                                                    <tr align="center" class="bg04">
                                                        <td align="right" height="35" style="width: 128px">
                                                            <asp:Label runat="server" ID="Label5">现已收回/归还金额：</asp:Label></td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtYsh" runat="server"></asp:TextBox>(请填写阿拉伯数字)
                                                        </td>
                                                    </tr>
                                                    <tr align="center" class="bg04">
                                                        <td align="right" height="35" style="width: 128px">
                                                            <asp:Label runat="server" ID="Label6">待收回/归还金额：</asp:Label></td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtDsh" runat="server"></asp:TextBox>(请填写阿拉伯数字)
                                                        </td>
                                                    </tr>
                                                    <tr align="center">
