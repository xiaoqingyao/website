<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ModifyTouZi.aspx.cs" Inherits="UserManger_ModifyTouZi" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom: 8px; margin-top: 8px;">
                <tr>
                    <td class='title'><span>修改投资信息</span></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                                            ...
                                            <td style="text-align: left;" valign="top" align="left">
                                                <table border="0" cellpadding="0" cellspacing="0" class="text008" width="100%">
                                                    <tr align="center" class="bg04">
                                                        <td align="right" height="35" style="width: 128px">投资科目：</td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtTzkm" runat="server" Width="392px"></asp:TextBox></td>
                                                    </tr>
                                                    <tr align="center" class="bg04">
                                                    ...
                                                    <tr align="center" class="bg04">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtTzsc" runat="server"></asp:TextBox>(月)
                                                        </td>
                                                    </tr>
                                                    <tr align="center" class="bg04">
                                                        <td align="right" height="35" style="width: 128px">投资金额：</td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtTzje" runat="server"></asp:TextBox>(请填写阿拉伯数字)
                                                        </td>
                                                    </tr>
                                                    <tr align="center" class="bg04">
                                                        <td align="right" height="35" style="width: 128px">预计收益：</td>
                                                        <td align="left">
                                                            <asp:TextBox ID="txtYjsy" runat="server"></asp:TextBox>(请填写阿拉伯数字)
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr align="center" class="bg04">
                                                        ...
                                                        <td align="left">
                                                            <asp:TextBox ID="txtXysy" runat="server"></asp:TextBox>(请填写阿拉伯数字)
                                                        </td>
                                                    </tr>
