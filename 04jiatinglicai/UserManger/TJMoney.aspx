    ...
    <form id="form1" runat="server">
        <div>
            <table width="100%" align="center" border="0" cellpadding="3" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom: 8px; margin-top: 8px;">
                <tr>
                    <td class='title'><span>家庭收支信息统计</span></td>
                </tr>
                <tr bgcolor="#FFFFFF">
                    <td align="left">
                            ...
                            <tr>
                                <td rowspan="3" valign="top" style="width: 706px" align="center">
                                    <table style="width: 100%;">
                                        <tr>
                                            <td align="left" style="text-align: center" valign="top">收支类型：<asp:DropDownList ID="drpSubItem" runat="server" Width="133px">
                        ...
                        &nbsp;
                        <asp:Button ID="Button4" runat="server" OnClick="Button4_Click" Text="统计" />&nbsp;<input type="button" value="打印" onclick="window.print();" /></td>
                                        ...
                                        <tr>
                                            <td align="left" style="text-align: center" valign="top"></td>
                                        </tr>
                                    </table>
                                </td>
                            </tr>
