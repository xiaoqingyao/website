        ...
        <TABLE height=10 cellSpacing=1 cellPadding=0 width=758 bgColor=#f5fafd align="center" border=0>
             <FORM  method=post runat="server">
                  ...
                  <TR>
                    ...
                    <TD width=537><asp:TextBox id="password1" size=20 runat="server">(查询时使用)</asp:TextBox>&nbsp;  
		   ...
		   <TD ><asp:button id="update" Text="下一步" runat="server"/></TD></TR>
		    <TR><TD>&nbsp;</TD></TR> 		
		  </FORM>
		</TABLE></TD></TR></TABLE>
