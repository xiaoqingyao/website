<%@ Page language="c#" src="jsxxgg.aspx.cs" AutoEventWireup="false" Inherits="class_lwtjxt.jsxxgg" %>
        ...
        <TABLE cellSpacing=1 cellPadding=0 width=758 bgColor=#f5fafd align="center" border=0>
		 ...
		 <TR><Td height=60>&nbsp;</TD></TR>
                  ...
                  <TR>
                    ...
                    <TD width=537><asp:TextBox id="password1" size=20 runat="server" ></asp:TextBox>&nbsp;  
                  ...
                  <TR>
                    ...
                    <TD width=537><asp:TextBox id="password2" size=20 runat="server" >确认密码</asp:TextBox>&nbsp; 
						...
						<asp:comparevalidator id="cv" controltovalidate="password1" controltocompare="password2" type="string" operator="equal" display="static" runat="server"><SPAN  class=p9>*两次输入的密码不一致</SPAN></asp:comparevalidator></TD></TR>
				   <TR>
				...
				<TR><TD>&nbsp;</TD></TR>    
				    ...
				    <TD class=p9 ><asp:button id="update" Text="更 新" runat="server"/>&nbsp;&nbsp;&nbsp;</a><a href="lwsh.aspx"> [返回上页]</a></TD>
				   </TR>
				    <TR><TD>&nbsp;</TD></TR> 
