<%@ Page Language="C#" MasterPageFile="~/SysManage/MasterPage.master" AutoEventWireup="true" CodeFile="MemberManage.aspx.cs" Inherits="SysManage_MemberManage" %>
                            ...
                            <asp:Repeater ID="rptList" runat="server"   onitemcommand="rptList_ItemCommand">
                                <ItemTemplate>
                                    <tr style=" height:25px;">
                                        ...
                                        <td align="center"><asp:Label ID="lblId" runat="server" Text='<%#Eval("MemberID")%>'></asp:Label></td>
                                        ...
                                        <td align="center">
                                            <a href="Memberoper.aspx?Id=<%#Eval("MemberID") %>"><img src="images/edt.gif" width="16" height="16" style="border:none;" /></a>&nbsp; &nbsp;
                                            <asp:LinkButton ID="LinkButton1"  OnClientClick="JavaScript:return confirm('确定要删除吗？')" runat="server" CommandArgument='<%#Eval("MemberID") %>' CommandName="del"><img src="images/del.gif" width="16" height="16" style="border:none" /></asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
