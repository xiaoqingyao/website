<%@ Page Language="C#" MasterPageFile="~/SysManage/MasterPage.master" AutoEventWireup="true" CodeFile="NewsManage.aspx.cs" Inherits="SysManage_NewsManage" %>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td style="padding:3px 0;">
                                    ...
                                    <input id="Button1" type="button" value="添  加" 
                                        onclick="javascript:location.href='newsoper.aspx?typeid=<%=typeid %>';" />
                            ...
                            <asp:Repeater ID="rptList" runat="server"   onitemcommand="rptList_ItemCommand">
                                <ItemTemplate>
                                    <tr style=" height:25px;">
                                        ...
                                        <td align="center"><asp:Label ID="lblId" runat="server" Text='<%#Eval("NewsId")%>'></asp:Label></td>
                                        <td align="center"><%#Eval("Title")%></td>
                                        <td align="center"><%#Eval("AddTime")%></td>
                                        <td align="center">
                                            <a href="newsoper.aspx?typeid=<%#typeid %>&Id=<%#Eval("NewsId") %>"><img src="images/edt.gif" width="16" height="16" style="border:none;" /></a>&nbsp; &nbsp;
                                            <asp:LinkButton ID="LinkButton1"  OnClientClick="JavaScript:return confirm('确定要删除吗？')" runat="server" CommandArgument='<%#Eval("NewsId") %>' CommandName="del"><img src="images/del.gif" width="16" height="16" style="border:none" /></asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
