<%@ Page Language="C#" MasterPageFile="~/SysManage/MasterPage.master" AutoEventWireup="true" CodeFile="PicClassOper.aspx.cs" Inherits="SysManage_PicClassOper" %>
                    ...
                    <tr>
                        ...
                        <td>
                            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#9FBD65" class="tab1">
                                <tr>
                                    <td width="100" align="right" style="height:30px">分类名称：</td>
                                    <td>
                                        <asp:TextBox ID="txtPicClassName" runat="server" CssClass="textbox" Width="150px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
