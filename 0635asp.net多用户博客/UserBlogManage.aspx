<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserBlogManage.aspx.cs" Inherits="UserBlogManage" %>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <a href="userBlogoper.aspx"><font color="blue">发布博客</font></a>
                            ...
                            <asp:Repeater ID="rptList" runat="server"   onitemcommand="rptList_ItemCommand">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="Bloginfo.aspx?id=<%#Eval("BlogId") %>" target="_blank"><%#Eval("BlogName")%></a>
                                        </td>
                                        <td align="center"><%#Eval("typename")%></td>
                                        <td align="center"><%#Eval("addtime")%></td>
                                        <td align="center"><%#Eval("hits")%></td>
                                        <td align="center">
                                            <a href="userBlogoper.aspx?Id=<%#Eval("BlogId") %>">修改</a>&nbsp; &nbsp;
                                            <asp:LinkButton ID="LinkButton1"  OnClientClick="JavaScript:return confirm('确定要删除吗？')" runat="server" CommandArgument='<%#Eval("BlogId") %>' CommandName="del">删除</asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
