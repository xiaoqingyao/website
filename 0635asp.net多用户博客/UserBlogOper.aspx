<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserBlogOper.aspx.cs" Inherits="UserBlogOper" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#9FBD65" class="tab1">
                                <tr>
                                    <td width="100" align="right" style="height:30px">博客标题：</td>
                                    <td>
                                        <asp:TextBox ID="txtBlogName" runat="server" CssClass="textbox" Width="260px"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100" align="right" style="height:30px">类型：</td>
                                    <td>
                                ...
                                <tr>
                                    <td width="100" align="right" style="height:30px">博客内容：</td>
                                    <td>
