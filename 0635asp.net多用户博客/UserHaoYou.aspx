<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserHaoYou.aspx.cs" Inherits="UserHaoYou" %>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="margin-top:10px;">
      <tr>
        <td valign="top" style="width:180px;height:24px; background:url(images/gy.jpg) repeat-x; text-align:center;border:solid 1px #ddd; font-size:14px;">
            ...
            <a href="userhaoyou.aspx"><font color="#2d7e17">我的收藏</font></a><br /><br />
                ...
                <td style="padding:10px 0 10px 10px;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#9FBD65" onmouseover="changeto()"  onmouseout="changeback()" class="tab1">
                            <tr class="top_tr">
                                ...
                                <td align="center">我的好友</td>
                                <td width="10%" align="center">操作</td>
                            </tr>
                            <asp:Repeater ID="rptList" runat="server"   onitemcommand="rptList_ItemCommand">
                                <ItemTemplate>
                                    <tr style="height:35px;">
                                        <td align="center"><asp:Label ID="lblId" runat="server" Text='<%#Eval("haoyouId")%>'></asp:Label></td>
                                        <td align="center"><%#Eval("tousername")%></td>
                                        <td align="center">
                                            <asp:LinkButton ID="LinkButton1"  OnClientClick="JavaScript:return confirm('确定要删除吗？')" runat="server" CommandArgument='<%#Eval("haoyouId") %>' CommandName="del">删除</asp:LinkButton>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
