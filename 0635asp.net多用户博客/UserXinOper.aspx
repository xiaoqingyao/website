<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserXinOper.aspx.cs" Inherits="UserXinOper" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#9FBD65" class="tab1">
                                ...
                                <tr>
                                    <td width="100" align="right" style="height:30px">发给：</td>
                                    <td>
                                        <asp:DropDownList ID="tousername" runat="server">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                                
                                <tr>
                                    <td width="100" align="right" style="height:30px">信内容：</td>
                                    <td>
                                        <asp:TextBox ID="txtXinName" runat="server" CssClass="textbox" TextMode="MultiLine" Rows="6" Columns="60"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="100" align="right" style="height:30px">时间：</td>
                                    <td>
                                        <%=DateTime.Now %>
                                    </td>
                                </tr>
