<%@ Page Language="C#" AutoEventWireup="true" CodeFile="edit.aspx.cs" Inherits="admin_Article_edit" %>
...
<body style="padding: 10px;">
    <form id="form1" runat="server">
        <div class="navigation">
            <span class="back"><a href="List.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 文章管理 &gt; 修改文章</b>
        </div>
