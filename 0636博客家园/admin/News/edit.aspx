...
<body>
    <form id="form1" runat="server">
        <div class="navigation">
            <span class="back"><a href="List.aspx">返回列表</a></span><b>您当前的位置：首页 &gt; 新闻管理 &gt; 发布新闻</b>
        </div>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
            ...
            <tr>
                ...
                <td width="85%">
                    <asp:TextBox ID="txtTitle" runat="server" CssClass="input w380 required" MaxLength="250"
                        minlength="3" HintTitle="发布的新闻标题" HintInfo="控制在100个字数内，标题文本尽量不要太长。"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                    <asp:TextBox ID="txtAuthor" runat="server" CssClass="input w250 required" MaxLength="50"
                        HintTitle="新闻作者" HintInfo="控制在50个字数内，如“管理员”。">管理员</asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtDate" runat="server" CssClass="input w250 required" MaxLength="50"
                        ReadOnly="true">管理员</asp:TextBox>
                </td>
            </tr>
        </table>
