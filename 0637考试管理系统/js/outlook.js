...
function b_writeStyle() {
  ...
  document.write(' font-size:12px; color:white; text-decoration: none; cursor:hand;vertical-align: middle;');
  ...
  document.write('.imgB {color:#1861C2; font-family:arial; font-size:9px;}');
  document.write('.hitred {color:red; font-family:arial; font-size:9px;}');
  ...
  if (bt.ns4) {                 //draw OutlookBar for ns4
    ...
    for (i=0;i<this.panels.length;i++) {
      ...
      if (!bt.op5) {
        ...
        document.write((this.width-c)+'; height:'+(35-c)+';"><A href="#" ');
