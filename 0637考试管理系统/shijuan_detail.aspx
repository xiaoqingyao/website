<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shijuan_detail.aspx.cs" Inherits="shijuan_detail" %>
            ...
            <tr>
                <td colspan="1">
                    <asp:DataList ID="DataList1" runat="server" BackColor="White" BorderColor="White"
                        ...
                        <ItemTemplate>
                            &nbsp;<asp:Label ID="Label2" runat="server" Font-Size="9pt" Height="19px" Width="1px"></asp:Label>
                ...
                <td colspan="1"><asp:DataList ID="DataList3" runat="server" BackColor="White" BorderColor="White"
                    ...
                    <ItemTemplate>
                        ...
                        <table style="width: 246px; font-size: 9pt;">
                            ...
                            <tr>
                                <td rowspan="4" style="width: 42px">
                                    <asp:TextBox ID='timu' runat='server'></asp:TextBox></td>
                            </tr>
                        </table>
                    </ItemTemplate>
                    <ItemStyle BackColor="White" ForeColor="#333333" />
