<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shijuanshengcheng_list2.aspx.cs" Inherits="shijuanshengcheng_list2" %>
            ...
            <tbody>
                ...
                NextPageText="下一页" PrevPageText="上一页" />
                            ...
                            <Columns>
                                ...
                                <asp:TemplateColumn HeaderText="开始考试">
                                <ItemTemplate>
                                    <a href='shijuan_detail2.aspx?id=<%#DataBinder.Eval(Container.DataItem, "id") %>'
                                       >开始考试</a>
                                </ItemTemplate>
                                </asp:TemplateColumn>
