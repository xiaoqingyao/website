<%@ Page Language="C#" AutoEventWireup="true" CodeFile="shijuanshengcheng_updt.aspx.cs" Inherits="shijuanshengcheng_updt" %>
	...
	<body>
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" borderColorDark="#9cc7ef" cellPadding="4" width="100%" align="center"
				...
				<tr bgColor="#4296e7">
					<td colSpan="2">
						<div align="center"><font color="#ffffff">修改试卷生成</font></div>
					</td>
				</tr>
