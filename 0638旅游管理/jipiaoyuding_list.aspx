            ...
            <tbody>
                ...
                NextPageText="下一页" PrevPageText="上一页" />
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField=banjibianhao HeaderText='班机编号'></asp:BoundColumn><asp:BoundColumn DataField=chufachengshi HeaderText='出发城市'></asp:BoundColumn><asp:BoundColumn DataField=daodachengshi HeaderText='到达城市'></asp:BoundColumn><asp:BoundColumn DataField=yudingshijian HeaderText='预订时间'></asp:BoundColumn><asp:BoundColumn DataField=yudingpiaoshu HeaderText='预订票数'></asp:BoundColumn><asp:BoundColumn DataField=nindexingming HeaderText='姓名'></asp:BoundColumn><asp:BoundColumn DataField=nindedianhua HeaderText='电话'></asp:BoundColumn><asp:BoundColumn DataField=nindeshenfenzheng HeaderText='身份证'></asp:BoundColumn><asp:BoundColumn DataField=beizhu HeaderText='备注'></asp:BoundColumn><asp:BoundColumn DataField=yonghuming HeaderText='用户名'></asp:BoundColumn>
