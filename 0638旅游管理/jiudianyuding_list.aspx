            ...
            <tbody>
                ...
                <tr class="tr1">
                    <td style="padding-left: 5px; height: 25px">
                        &nbsp;预订人姓名：<asp:TextBox ID="bh" runat="server"></asp:TextBox>酒店名称：<asp:TextBox ID="mc"
                        ...
                        <asp:DataGrid ID="DataGrid1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField=jiudianmingcheng HeaderText='酒店名称'></asp:BoundColumn><asp:BoundColumn DataField=kefangbianhao HeaderText='客房编号'></asp:BoundColumn><asp:BoundColumn DataField=yudingshijian HeaderText='预订时间'></asp:BoundColumn><asp:BoundColumn DataField=yudingtianshu HeaderText='预订天数'></asp:BoundColumn><asp:BoundColumn DataField=nindexingming HeaderText='预订人姓名'></asp:BoundColumn><asp:BoundColumn DataField=nindedianhua HeaderText='预订人电话'></asp:BoundColumn><asp:BoundColumn DataField=nindeshenfenzheng HeaderText='预订人身份证'></asp:BoundColumn><asp:BoundColumn DataField=beizhu HeaderText='备注'></asp:BoundColumn>
