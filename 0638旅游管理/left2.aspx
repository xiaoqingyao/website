    ...
    <td align="center" valign="top" bgcolor="D4ECFC">
      <table width="162" height="100%" cellpadding="0" cellspacing="0">
          ...
          <table width="145" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="89" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="30" style="cursor:hand" onMouseOver="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span class="STYLE2">&nbsp;<a href="yonghuzhuce_updt2.aspx" target="hsgmain">个人资料管理</a></span></td>
                    </tr>
                  </table></td>
                </tr>
        ...
        <tr id="Tr1" onClick="show(2)">
          <td height="25" background="images/list_task.jpg"> <span class="style1">购物订单管理</span></td>
        </tr>
        <tr id="show2" style="display:none">
          ...
          <table width="145" border="0" align="center" cellpadding="0" cellspacing="0">
                 ...
                 <tr>
                  ...
                  <td width="89" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="30" style="cursor:hand" onMouseOver="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span class="STYLE2">&nbsp;<a href="dd_list.aspx" target="hsgmain">购物订单管理</a></span></td>
                    </tr>
                  </table></td>
                </tr>
        </table></td>
        ...
        <tr id="Tr2" onClick="show(3)">
          <td height="25" background="images/list_task.jpg"> <span class="style1">酒店预订管理</span></td>
        </tr>
        <tr id="show3" style="display:none">
          ...
          <table width="145" border="0" align="center" cellpadding="0" cellspacing="0">
                 ...
                 <tr>
                  ...
                  <td width="89" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="30" style="cursor:hand" onMouseOver="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span class="STYLE2">&nbsp;<a href="jiudianyuding_list2.aspx" target="hsgmain">酒店预订管理</a></span></td>
                    </tr>
                  </table></td>
                </tr>
        ...
        <tr id="Tr3" onClick="show(4)">
          <td height="25" background="images/list_task.jpg"> <span class="style1">机票预订管理</span></td>
        </tr>
        <tr id="show4" style="display:none">
          ...
          <table width="145" border="0" align="center" cellpadding="0" cellspacing="0">
                 ...
                 <tr>
                  ...
                  <td width="89" height="30"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="30" style="cursor:hand" onMouseOver="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#adb9c2'; "onmouseout="this.style.backgroundImage='url()';this.style.borderStyle='none'"><span class="STYLE2">&nbsp;<a href="jipiaoyuding_list2.aspx" target="hsgmain">机票预订管理</a></span></td>
                    </tr>
                  </table></td>
                </tr>
