...
<body>
    <form id="form1" runat="server">
        ...
        <div id="container">
         <fieldset style="width: 750px; height: 383px; text-align: center">
        ...
        <table style="width: 693px; height: 22px"><tr>
            ...
            <td style="width: 637px; height: 40px;">
                <asp:Button ID="Button1" runat="server" Height="38px" Text="查询学生名单" Width="101px" OnClick="Button1_Click" /></td></tr></table>
        <asp:GridView ID="GridView1"  BorderColor="Black" OnRowDataBound="GridView1_RowDataBound"   runat="server" AutoGenerateColumns="False"  Font-Size="12px" Width="694px" AllowSorting="True" >
          <Columns>
