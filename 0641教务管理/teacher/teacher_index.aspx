<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacher_index.aspx.cs" Inherits="teacher_index" %>
...
<body background="../Image/back_01.gif" style="text-align: center">
 ...
 <div style="text-align: center">
        <table align="center" bgcolor="#ffffff" border="0" bordercolor="#215dc6" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td height="453" rowspan="2" style="width: 159px">
                    &nbsp;<iframe src=Tleft.htm style="width: 163px; height: 453px" frameborder=0 scrolling=no></iframe>
                </td>
                <td bgcolor="#333300" style="text-align: left; height: 26px; width: 708px;">
                    ...
                    <span style="color: #ffffff">用户身份：教师 </span>
            ...
            <tr>
                <td height="155" style="width: 708px">
                    <iframe name="menu" frameborder=0 scrolling=auto style="width: 820px; height: 422px" src=teacherChangePwd.aspx></iframe>
                    &nbsp;</td>
            </tr>
            <tr>
