<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Add.aspx.cs" ValidateRequest="false" Inherits="account_Add" Title="" %>
...
<tr>
<td  style=" text-align:right; width:30%;">操作日期:</td>
<td class="tbright"><div style="display:inline;float:left;">
...
<tr>
<td  style=" text-align:right; width:30%;">操作类型:</td>
<td class="tbright"><div style="display:inline;float:left;">
  <asp:RadioButtonList ID="rblType" runat="server" 
        RepeatDirection="Horizontal" RepeatLayout="Flow">
      <asp:ListItem Selected="True">存款</asp:ListItem>
      <asp:ListItem>取款</asp:ListItem>
    </asp:RadioButtonList>  </div>
    
 </td></tr>

<tr>
<td  style=" text-align:right; width:30%;">操作金额:</td>
<td class="tbright"><div style="display:inline;float:left;">
