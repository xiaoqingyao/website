<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="account_Manage" Title="" %>
...
<strong> 操作人</strong><asp:DropDownList ID="ddlfamily_Id" runat="server" Width="200">
</asp:DropDownList>
...
<%# Container.ItemIndex+1 %></td>
 ...
 <td align="center"><%# Eval("account_Time", "{0:yyyy-MM-dd}")%></td>
 <td align="center"><%# Eval("family_Name")%></td>

 <td align="center"><%# Eval("account_Money")%></td>
  <td align="center"><%# Eval("account_type").ToString() == "存款" ? "<span style='color:Green'>存款</span>" : "<span style='color:Red'>取款</span>"%></td>
...
<td align="center">
    <a href="Detail.aspx?id=<%# Eval("account_Id") %>"><img src="../images/ico_view.gif" width="16" height="16" style="border:0px;" title="查看该记录" /></a> 
        <% if (Session["power"].ToString() == "管理员")
           { %>
       <a href="Detail1.aspx?id=<%# Eval("account_Id") %>">审核</a>
    <a href="Modify.aspx?id=<%# Eval("account_Id") %>"><img src="../images/ico_edit.gif" width="16" height="16" style="border:0px;" title="修改该记录" /></a> 
    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../images/ico_del.gif" ToolTip="删除该记录"  OnClick="del_Click"  CommandArgument='<%# Eval("account_Id") %>' OnClientClick='return confirm("您确定要删除此信息么？");' />
<%} %>
</td>
</tr>
    </ItemTemplate>
...
<table border="0" cellpadding="0" cellspacing="1" style="width: 100%;">
  <tr>
   <td align="left"> &nbsp;&nbsp;&nbsp;&nbsp; 共存款：<asp:Label ID="Label2" 
