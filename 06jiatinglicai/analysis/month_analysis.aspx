<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="month_analysis.aspx.cs" Inherits="analysis_month_analysis" Title="" %>
...
<table width="100%" border="0" cellspacing="0" cellpadding="1" class="tbbc">
 ...
 <td align="center"><%# decimal.Parse(Eval("t3").ToString()) > 0 ? "<span style='color:green'>" + Eval("t3").ToString() + " ↑</span>" : decimal.Parse(Eval("t3").ToString()) == 0 ? "<span >" + Eval("t3").ToString() + " --</span>" : "<span style='color:Red'>" + Eval("t3").ToString() + " ↓</span>"%></td>
...
<table border="0" cellpadding="0" cellspacing="1" style="width: 100%;">
  <tr>
   <td align="center">&nbsp;&nbsp;&nbsp;&nbsp; 共收入：<asp:Label ID="Label2" 
          ...
          Text="Label"></asp:Label>元，实际收入：<asp:Label 
