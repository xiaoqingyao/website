...
<table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
    <tr>
        ...
        <strong> 购入人</strong><asp:DropDownList ID="ddlfamily_Id" runat="server" Width="150">
</asp:DropDownList>
<strong> 资产名称:</strong><asp:TextBox ID="txt_assets_Name" runat="server" width="150"></asp:TextBox>
...
<td align="center">
    <a href="Detail.aspx?id=<%# Eval("assets_Id") %>"><img src="../images/ico_view.gif" width="16" height="16" style="border:0px;" title="查看该记录" /></a> 
        <% if (Session["power"].ToString() == "管理员")
           { %>
       <a href="Detail1.aspx?id=<%# Eval("assets_Id") %>">审核</a>
    <a href="Modify.aspx?id=<%# Eval("assets_Id") %>"><img src="../images/ico_edit.gif" width="16" height="16" style="border:0px;" title="修改该记录" /></a> 
    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../images/ico_del.gif" ToolTip="删除该记录"  OnClick="del_Click"  CommandArgument='<%# Eval("assets_Id") %>' OnClientClick='return confirm("您确定要删除此信息么？");' />
    <%} %>
</td>
</tr>
    </ItemTemplate>
...
<table border="0" cellpadding="0" cellspacing="1" style="width: 100%;">
  ...
  <td align="left"> &nbsp;&nbsp;&nbsp;&nbsp; 资产合计：<asp:Label ID="Label2" 
