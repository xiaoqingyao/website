<%@ Page Language="C#" MasterPageFile="~/main.master" AutoEventWireup="true" CodeFile="Manage.aspx.cs" Inherits="invest_Manage" Title="" %>
...
<table style="width: 100%;" cellpadding="2" cellspacing="1" class="border">
    <tr>
        ...
        <strong> 操作人</strong><asp:DropDownList ID="ddlfamily_Id" runat="server" Width="150">
</asp:DropDownList>
<strong> 投资项目:</strong><asp:TextBox ID="txt_invest_Title" runat="server" width="150"></asp:TextBox>
...
<%# Container.ItemIndex+1 %></td>
 <td align="center"><%# Eval("invest_Title")%></td>
 <td align="center"><%# Eval("invest_Time")%></td>
 <td align="center"><%# Eval("invest_Money")%></td>
...
<td align="center">
    <a href="Detail.aspx?id=<%# Eval("invest_Id") %>"><img src="../images/ico_view.gif" width="16" height="16" style="border:0px;" title="查看该记录" /></a> 
      <% if (Session["power"].ToString() == "管理员")
         { %>
       <a href="Detail1.aspx?id=<%# Eval("invest_Id") %>">审核</a>
    <a href="Modify.aspx?id=<%# Eval("invest_Id") %>"><img src="../images/ico_edit.gif" width="16" height="16" style="border:0px;" title="修改该记录" /></a> 
    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../images/ico_del.gif" ToolTip="删除该记录"  OnClick="del_Click"  CommandArgument='<%# Eval("invest_Id") %>' OnClientClick='return confirm("您确定要删除此信息么？");' />
<%} %>
</td>
</tr>
    </ItemTemplate>
...
<table border="0" cellpadding="0" cellspacing="1" style="width: 100%;">
  <tr>
    <td align="left"> &nbsp;&nbsp;&nbsp;&nbsp; 投资总金额：<asp:Label ID="Label2" 
