  ...
  <tr>
    ...
    <td width='80%' align="right" valign="bottom">
      ...
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<asp:Label ID="Label1" runat="server" Text="Label" Font-Bold="True" 
                Font-Size="Medium" ForeColor="Red"></asp:Label>，您的身份是：<asp:Label 
                ID="Label2" runat="server" Text="Label" Font-Bold="True" Font-Size="Medium" 
                ForeColor="Red"></asp:Label>，欢迎使用家庭财务管理系统！
        	
        	[<asp:LinkButton ID="LinkButton1" runat="server" onclick="LinkButton1_Click">注销退出</asp:LinkButton>]&nbsp;
      </td>
      </tr>
      <tr>
