<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FenLei_List.aspx.cs" Inherits="Admin_FenLei_List" %>
...
<body>
    ...
    <table   border="1" bordercolordark="#9cc7ef" bordercolorlight="#145aa0"
                  ...
                  <asp:GridView 
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="TypeID" 
                                DataNavigateUrlFormatString="FenLei.aspx?ID={0} " HeaderText="编辑" Text="编辑" />
                            <asp:HyperLinkField DataNavigateUrlFields="TypeID" DataNavigateUrlFormatString="FenLeiD.aspx?ID={0} "
            ...
            <tr>
                <td colspan="1">
                    <div align="center">
                        <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Admin/FenLei.aspx" Target="_self">添加</asp:HyperLink>&nbsp;</div>
                </td>
            </tr>
            <tr bgcolor="#4296e7">
                <td colspan="1">
