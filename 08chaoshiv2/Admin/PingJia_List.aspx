<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PingJia_List.aspx.cs" Inherits="PingJia_List" %>
...
<body>
    ...
    <table   border="1" bordercolordark="#9cc7ef" bordercolorlight="#145aa0"
            ...
            <tr bgcolor="#4296e7">
                <td colspan="1" style="height: 24px"align=center class="style1">                     查看评价</td>
            </tr>
            <tr>
                <td   align="left">
                  <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFields="GoodsID" 
                                DataNavigateUrlFormatString="PJGoods_List.aspx?ID={0} " HeaderText="查看评价" Text="查看评价" />
