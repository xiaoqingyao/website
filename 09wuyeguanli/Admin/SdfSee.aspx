<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SdfSee.aspx.cs" Inherits="Admin_SdfSee" %>
				...
				<table id="Table1" cellspacing="1" cellpadding="1" width="642" align="center" border="1"
                    ...
                    <tr>
                        <td align="center" style="width: 20%; height: 21px">
                            收费月份：</td>
                        <td align="left" style="height: 21px" valign="middle" width="30%">
                            <asp:TextBox ID="TextBox6" runat="server" Width="106px" ReadOnly="True">200711</asp:TextBox>(yyyymm)</td>
                        <td align="center" style="height: 21px" width="20%">
                            收费总额：</td>
                        <td align="left" style="height: 21px">
					...
					<tr>
						<td align="center" colspan="4" style="HEIGHT: 43px">
							<asp:button id="Button2" runat="server" Width="68px" Text="作废单据" OnClick="Button2_Click"></asp:button>
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="取消" Width="68px" />&nbsp;</td>
					</tr>
				</table>
			</font>
		</form>
