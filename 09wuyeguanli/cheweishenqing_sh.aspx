<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cheweishenqing_sh.aspx.cs"
    Inherits="cheweishenqing_sh" %>
                    ...
                    <asp:DataGrid ID="GridView1" runat="server" AllowPaging="True" PageSize="18" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateColumn HeaderText="申请人">
                                ...
                                <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" Font-Size="12px" />
                                <ItemTemplate>
                                    <%# DataBinder.Eval(Container, "DataItem.申请人")%>
                                </ItemTemplate>
                            </asp:TemplateColumn>
                            <asp:TemplateColumn>
                                <ItemTemplate>
                                    <asp:Button runat="server" ID="TongYi" Text="通过" OnClick="TongYi_Click" CommandArgument='<%#Eval("ID") %>' />
                                </ItemTemplate>
                            </asp:TemplateColumn>
                        </Columns>
