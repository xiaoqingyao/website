<%@ Page Language="C#" AutoEventWireup="true" CodeFile="add_Type.aspx.cs" Inherits="Admin_add_Type" %>
...
<body>
    ...
    <div>
        ...
        <tr><td>
            <table cellpadding="0" cellspacing="0" style="background-color: #ffffff" width="400">
                <tr>
                    ...
                    <td style="height: 8px; width: 29px;">
                ...
                <tr>
                    ...
                    <td style="vertical-align: top; width: 684px; height: 179px; text-align: left">
                        <table cellpadding="0" cellspacing="0" width="100%" style="border-right: darkgray 1px solid; border-top: darkgray 1px solid; border-left: darkgray 1px solid; border-bottom: darkgray 1px solid">
                            <tr>
                                ...
                                <td style="height: 149px">
                                    <table cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td style="height: 29px; font-weight: bold; font-size: 15px; color: black;">
                                                &nbsp;添加类别</td>
        ...
        <asp:TextBox ID="txtTypeName" runat="server"></asp:TextBox></td>
                                      ...
                                      <tr>
                                            <td style="height: 34px; width: 27px;">
                                            </td>
                    ...
                    <td style="background-image: url(../../Image/box2_05.gif); height: 179px; width: 29px;">
                    </td>
                </tr>
                <tr>
                    <td style="height: 8px">
