<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PredeterminedTicket.aspx.cs" Inherits="PredeterminedTicket" Title="Untitled Page" %>
        ...
        <tr>
            <td align="left" colspan="3" rowspan="2" style="background-position: center center;
                ...
                <asp:LinkButton ID="Linkbuy" runat="server" BackColor="MediumTurquoise" ForeColor="Black"
                    Height="18px"  Width="91px" OnClick="Linkbuy_Click">　预　览　</asp:LinkButton>
                &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="3" rowspan="2">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <tr>
                        <td align="left" style="width: 130px; height: 31px">
                            种类：</td>
                    ...
                    <tr>
                        <td align="left" colspan="3" style="height: 31px">
                            <asp:LinkButton ID="LinkButton1" runat="server" BackColor="MediumTurquoise" ForeColor="Black"
                                Width="80px" OnClick="LinkButton1_Click">　预　定　</asp:LinkButton></td>
                    </tr>
                </table>
                &nbsp;
