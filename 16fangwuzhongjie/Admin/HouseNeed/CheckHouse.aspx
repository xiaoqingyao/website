<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true"
    CodeBehind="CheckHouse.aspx.cs" Inherits="houseIntermediaryMIS.Admin.HouseNeed.CheckHouse" %>
                    ...
                    <asp:Repeater ID="Repeater1" runat="server" EnableViewState="False">
                        ...
                        <ItemTemplate>
                            <tr height="26" class="cp" onmouseover="this.style.backgroundColor='#C5D5E5'" onmouseout="this.style.backgroundColor=''">
                                ...
                                <td align="center">
                                    <a href='CHouseDetail.aspx?ID=<%# DataBinder.Eval( Container.DataItem,"ID")%>&type=<%# DataBinder.Eval( Container.DataItem,"type")%>'>
