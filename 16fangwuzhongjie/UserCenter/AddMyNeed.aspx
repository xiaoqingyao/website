<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMyNeed.aspx.cs" Inherits="houseIntermediaryMIS.UserCenter.AddMyNeed" %>
...
<body leftmargin="0" topmargin="0">
    <form id="Form1" method="post" runat="server">
        ...
        <table id="table1" width="900" align="center" cellpadding="0" cellspacing="0">
            <tr>
                    ...
                    <table cellspacing="1" cellpadding="1" width="100%" align="center" border="0" style="font-size: 14px">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                &nbsp; <font color="Red">*</font>信息类型<select id="dropIsAgency" name="dropIsAgency"
                                    runat="server">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span style="font-size: 14px">（请填写需求地段）</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="right">
                        ...
                        <tr>
                            ...
                            <span style="font-size: 14px">(面积不限请输入0)</span>&nbsp;&nbsp;
                            <asp:Label ID="lblPrice1" runat="server">租价</asp:Label><asp:TextBox ID="Price" onblur="Isvalidity(Price,'价格')"
                                ...
                                <asp:Label ID="lblPrice2" runat="server" Text="Label">元</asp:Label>&nbsp;<span style="font-size: 14px">(价格面议请输入0)</span>
                            </td>
                        </tr>
                        <tr>
                            <td align="right" width="20%">详细需求描述：
                            </td>
                            <td valign="top" align="left">
                                <span style="font-size: 14px">（可填写其它个人要求，字数不超过500字。）</span><br />
                                <asp:TextBox ID="Other" runat="server" Width="450px" TextMode="MultiLine" Height="70"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td align="center" width="20%" colspan="2">
                                <asp:Button ID="btnSubmit" runat="server" Text="提 交" OnClick="btnSubmit_Click"></asp:Button>
