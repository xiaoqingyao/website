<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyNeed.aspx.cs" Inherits="houseIntermediaryMIS.UserCenter.MyNeed" %>
            ...
            <td valign="top">
                <table border="0" width="100%" align="center">
                    <tr>
                        <td>
                            <p>
                                <b><font face="宋体" color="Red">当前位置：-&gt;我的求租求购信息</font></b></p>
                        </td>
                    </tr>
                </table>
                <table id="tableList" width="100%" border="0" align="center" style="padding-left: 20px">
                    <tbody>
                        <tr>
                            <td bgcolor="#f0f0f0">
                                租售信息管理
                                ...
                                <asp:Repeater ID="Repeater1" runat="server" OnItemDataBound="Repeater1_ItemDataBound" >
                                    ...
                                    <ItemTemplate>
                                        <tr onmouseover="this.style.backgroundColor='#B6D2E0'" onmouseout="this.style.backgroundColor=''">
                                            ...
                                            <td align="left">
                                                <a href='<%# Url.GetNeedDetailUrl(Convert.ToInt32(DataBinder.Eval( Container.DataItem,"ID")))%>'
                                                    target="_blank"><font class="Orange">
                                                        <%# Tools.GetShowedAddr( Convert.ToString( DataBinder.Eval( Container.DataItem,"Addr")),12)%></font></a>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <asp:LinkButton ID="lkbDelete" runat="server" CommandName='<%# Eval("ID") %>' OnCommand="lkbDelete_Click"
                                                    OnClientClick="return confirm('确定要删除吗？该操作不可恢复！！！')">删除</asp:LinkButton>
                                            </td>
                                        </tr>
                                    </ItemTemplate>
                                    <FooterTemplate>
