        ...
        <tr>
            ...
            <td align="left" style="width: 580px">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtOldPassWord"
                    ErrorMessage="*" style="position: absolute"></asp:RequiredFieldValidator></td>
        </tr>
        <tr>
            <td align="right" style="width: 122px">
        ...
        <tr>
            ...
            <td align="left" style="width: 580px">
                ...
                <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtNewPassWord"
                    ControlToValidate="txtReNewPassWord" ErrorMessage="CompareValidator" style="position: absolute" Width="190px">两次输入的密码不一样</asp:CompareValidator></td>
        </tr>
        <tr>
            <td align="right" style="width: 122px">
                &nbsp; &nbsp;</td>
