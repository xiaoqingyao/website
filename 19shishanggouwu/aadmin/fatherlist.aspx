...
<div style="margin:20px auto; " class="auto-style5">
<div>
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
        Height="103px" Width="442px" onrowcommand="GridView1_RowCommand" 
...
<div>
    <table cellpadding="0" cellspacing="0" class="style1">
        <tr>
            <td>
                你所选择修改的ID:<asp:Label ID="f_id" runat="server" Text="（*请在列表中选择所要修改的行）" ForeColor="Red"></asp:Label></td>
        </tr>
        <tr>
            <td>
                新父类名称：<asp:TextBox ID="TextBox1" runat="server" Height="21px" Width="177px"></asp:TextBox></td>
        </tr>
        <tr>
