...
<div>　　　　&nbsp; 会&nbsp; 员 号：<asp:TextBox ID="TextBox1" runat="server"></asp:TextBox></div>
...
<div style="height:5px;"></div>
<div>　　　&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; QQ：　<asp:TextBox ID="TextBox5" runat="server"></asp:TextBox>
    </div>
<div style="height:5px;"></div>
<div>　　&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 手机号：<asp:TextBox ID="TextBox6" runat="server"></asp:TextBox></div>
<div style="height:5px;"></div>
