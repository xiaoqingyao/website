    ...
    .alk
    {
     ...
     .blkk
     {
        ...
        <asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
            <div class="shoplist">
        <div><img src="images/pay_setp_02[1].gif" /></div>
        <div  class="s_3">
        <div  class="s_all">
       

        <div class="s_1"> 
        <div style="text-align:left;"><img src="images/pay_ico_01[1].gif" /></div>
...
&nbsp;</td>
        ...
        <div class="s_4">
        <div style="text-align:left;"><img src="images/pay_ico_03[1].gif" /></div>
        <table cellpadding="5" cellspacing="5" width="90%" >
        <tr>
         <td>支付方式：</td>
         <td> 
...
&nbsp;（需额外支付10元配送手续费）<br />
        ...
        2.请按照订单金额支付相应的货款，切勿随意或过多支付。（订单金额以网站订单支付页面显示的总金额为准）  </td>
         ...
         <td> 
           ...
           <div class="s_4">
           <div><img src="images/pay_ico_05[1].gif" /> 　　<a href="shoplist.aspx">[返回购物车修改]</a></div>
           <br />
        ...
        <Columns>
         ...
         <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="商品属性">
               <ItemTemplate>
                  颜色： <asp:Label ID="color" runat="server" Text=' <%#Eval("color")%>'></asp:Label>,尺寸：<asp:Label
                       ID="size" runat="server" Text='<%#Eval("size")%>'></asp:Label>, 类别：<asp:Label ID="cate" runat="server" Text='<%#Eval("cate")%>'></asp:Label>
               </ItemTemplate>
            </asp:TemplateField>
...
<div>
    <div style="text-align:right; padding-right:25px; padding-top:15px;">
        <asp:ImageButton ID="ImageButton1" runat="server"  
            ImageUrl="images/but_submit[1].gif" onclick="ImageButton1_Click" /></div>
           </div>
        </div>
