<%@ Page Language="C#" AutoEventWireup="true" CodeFile="yingyuanlist.aspx.cs" Inherits="yingyuanlist" %>
                                            ...
                                            <asp:DataGrid ID="DataGrid1" runat="server" AllowPaging="True" AllowSorting="True"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateColumn HeaderText="删除">
                                                        <ItemTemplate>
                                                            <a href='delid.aspx?delid=<%#DataBinder.Eval(Container.DataItem, "id") %>&tablename=yingyuan&npage=yingyuanlist.aspx'
