<%@ Page Language="C#" MasterPageFile="~/JXC.master" AutoEventWireup="true" CodeFile="XS_XS.aspx.cs" Inherits="XS_XS_XS" Title="某进销存管理系统--销售相关信息设置" %>
...
<div><strong style="color:Red;"> 销售相关信息设置</strong><br />
<div style="text-align: left;color: #ff0000;">销售单</div>
    <asp:GridView ID="gvXsd" runat="server" AutoGenerateColumns="False" AllowPaging="True" Height="160px" Width="840px" BorderStyle="None" PageSize="5" OnRowDataBound="gvRkd_RowDataBound" OnRowCommand="gvXsd_RowCommand" >
        <Columns>
            <asp:BoundField DataField="xsrq" HeaderText="日期" />
            <asp:BoundField DataField="ywy" HeaderText="业务员" />
            <asp:BoundField DataField="xsdbh" HeaderText="编号" />
            <asp:BoundField DataField="xsddbh" HeaderText="订单号" />
            <asp:TemplateField HeaderText="客户">
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# getKhmcByKhbh(Eval("khbh").ToString()) %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            ...
            <asp:TemplateField HeaderText="编辑">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnEdit" runat="server" ForeColor="#996600" CommandName="Ed" CommandArgument='<%# Eval("xsdbh")%>' >编辑</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:TemplateField HeaderText="删除">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnDelete" runat="server" ForeColor="#996600" CommandName="De" CommandArgument='<%# Eval("xsdbh")%>' >删除</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
    ...
    <div style="text-align: left;">
     供&nbsp;&nbsp;应&nbsp;&nbsp;商:<asp:DropDownList ID="ddlkhgx" runat="server"></asp:DropDownList>
     ...
     入库日期:<asp:TextBox ID="txtbxsrqgx" runat="server" onFocus="new WdatePicker(this,'%Y-%M-%D',true,'default')"></asp:TextBox>
     ...
     <asp:Label ID="lblmassagegx" runat="server" Height="20px" Width="337px" ForeColor="Red"></asp:Label><br />
      供&nbsp;&nbsp;应&nbsp;&nbsp;商:<asp:DropDownList ID="ddlkhtj" runat="server"></asp:DropDownList>
     ...
     入库日期:<asp:TextBox ID="txtbxsrqtj" runat="server" onFocus="new WdatePicker(this,'%Y-%M-%D',true,'default')"></asp:TextBox>
     ...
     <div style="text-align: left; color: #ff0000; ">销售订单</div>
     <asp:GridView ID="gvXsdd" runat="server" AutoGenerateColumns="False" AllowPaging="True" Height="160px" Width="840px" BorderStyle="None" PageSize="5" OnRowDataBound="gvXsdd_RowDataBound" OnRowCommand="gvXsdd_RowCommand"  >
        <Columns>
            <asp:BoundField DataField="xsrq" HeaderText="订货日期" >
            </asp:BoundField>
            <asp:TemplateField HeaderText="业务员">
                <ItemTemplate>
                    <asp:Label ID="Label4" runat="server" Text='<%# getYwymcByYwybh(Eval("ywy").ToString()) %>'></asp:Label>
                </ItemTemplate>
            </asp:TemplateField>
            <asp:BoundField DataField="xsddbh" HeaderText="订单号" />
            <asp:TemplateField HeaderText="客户">
            ...
            <asp:TemplateField HeaderText="生成销售单">
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnEdit" runat="server" ForeColor="#996600" CommandName="Rkd" CommandArgument='<%# Eval("xsddbh")%>' >生成销售单</asp:LinkButton>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
        <HeaderStyle BackColor="#CCFF99" />
