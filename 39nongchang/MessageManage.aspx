<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MessageManage.aspx.cs" Inherits="MessageManage" %>
                ...
                <div class="ui_tb">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table" CellPadding="0" CellSpacing="0" AutoGenerateColumns="false" Width="100%" BorderWidth="0">
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFormatString="~/MessageEdit.aspx?code={0}" DataNavigateUrlFields="id" Text="编辑" ControlStyle-CssClass="edit" />
                            <asp:HyperLinkField DataNavigateUrlFormatString="~/MessageManage.aspx?code={0}" DataNavigateUrlFields="id" Text="删除"  />
                        </Columns>
                    </asp:GridView>
