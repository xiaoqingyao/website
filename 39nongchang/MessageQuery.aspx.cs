...
public partial class MessageQuery : BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            {
                //删除
                string delSql = "delete from message where id='" + code.ToString() + "'";
    ...
    {
        string sql = "select *,Row_Number()over(order by pubdate desc,id asc) as crow from message where 1=1 ";
