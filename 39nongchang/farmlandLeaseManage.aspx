<%@ Page Language="C#" AutoEventWireup="true" CodeFile="farmlandLeaseManage.aspx.cs" Inherits="farmlandLeaseManage" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("a.edit").fancybox({
                ...
                'onClosed': function () {
                    window.location.href = 'farmlandLeaseManage.aspx';
                }
            });
        });
    </script>
                ...
                <div class="ui_tb">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table" CellPadding="0" CellSpacing="0" AutoGenerateColumns="false" Width="100%" BorderWidth="0">
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFormatString="~/farmlandLeaseEdit.aspx?code={0}" DataNavigateUrlFields="code" Text="出租" ControlStyle-CssClass="edit" />
                        </Columns>
                    </asp:GridView>
