<%@ Page Language="C#" AutoEventWireup="true" CodeFile="farmlandRevokeManage.aspx.cs" Inherits="farmlandRevokeManage" %>
                ...
                <div class="ui_tb">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table" CellPadding="0" CellSpacing="0" AutoGenerateColumns="false" Width="100%" BorderWidth="0">
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFormatString="~/farmlandRevokeManage.aspx?code={0}" DataNavigateUrlFields="code" Text="土地收回" />
                        </Columns>
                    </asp:GridView>
