<%@ Page Language="C#" AutoEventWireup="true" CodeFile="farmlandTransferManage.aspx.cs" Inherits="farmlandTransferManage" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("a.edit").fancybox({
                ...
                'onClosed': function () {
                    window.location.href = 'farmlandTransferManage.aspx';
                }
            });
        });
    </script>
                ...
                <div class="ui_tb">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table" CellPadding="0" CellSpacing="0" AutoGenerateColumns="false" Width="100%" BorderWidth="0">
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="当前承租人编号" DataField="tenantryCode" />
                            <asp:BoundField HeaderText="当前承租人姓名" DataField="tenantryName" />
                            <asp:BoundField HeaderText="创建日期" DataField="createDate" />
                            <asp:BoundField HeaderText="状态" DataField="status" />
                            <asp:HyperLinkField DataNavigateUrlFormatString="~/farmlandTransferEdit.aspx?code={0}" DataNavigateUrlFields="code" Text="转租" ControlStyle-CssClass="edit" />
                        </Columns>
                    </asp:GridView>
