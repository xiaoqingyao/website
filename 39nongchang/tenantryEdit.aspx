<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tenantryEdit.aspx.cs" Inherits="tenantryEdit" %>
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                 ...
                 <tr>
                    <td class="ui_text_rt">押金：</td>
                    <td class="ui_text_lt">
                        <asp:TextBox runat="server" ID="deposit" CssClass="ui_input_txt01" Width="200"></asp:TextBox>
                    </td>
                </tr>
                <tr>
