<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tenantryManage.aspx.cs" Inherits="tenantryManage" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#addBtn").fancybox({
                ...
                'onClosed': function () {
                    window.location.href = 'tenantryManage.aspx';
                }
            });
            /**编辑   **/
            $("a.edit").fancybox({
            ...
            <div class="ui_content">
                <div class="ui_text_indent">
                    <div id="box_border">
                        ...
                        <div id="box_center">
                            姓名：<asp:TextBox ID="txtName" runat="server" CssClass="ui_input_txt02"></asp:TextBox>
                        </div>
                        <div id="box_bottom">
                ...
                <div class="ui_tb">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table" CellPadding="0" CellSpacing="0" AutoGenerateColumns="false" Width="100%" BorderWidth="0">
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFormatString="~/farmerEdit.aspx?code={0}" DataNavigateUrlFields="code" Text="编辑" ControlStyle-CssClass="edit" />
                            <asp:HyperLinkField DataNavigateUrlFormatString="~/farmerManage.aspx?code={0}" DataNavigateUrlFields="code" Text="删除"  />
                        </Columns>
                    </asp:GridView>
