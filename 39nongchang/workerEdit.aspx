<%@ Page Language="C#" AutoEventWireup="true" CodeFile="workerEdit.aspx.cs" Inherits="workerEdit" %>
        ...
        <div class="ui_content">
            <table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        <asp:TextBox runat="server" ID="age" CssClass="ui_input_txt01" Width="200"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td class="ui_text_rt">性别：</td>
                    <td class="ui_text_lt">
                        <asp:TextBox runat="server" ID="sex" CssClass="ui_input_txt01" Width="200"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="ui_text_lt">
                        ...
                        <asp:HiddenField ID="farmerCode" runat="server" />
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
