<%@ Page Language="C#" AutoEventWireup="true" CodeFile="workerManage.aspx.cs" Inherits="workerManage" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $("#addBtn").fancybox({
                ...
                'onClosed': function () {
                    window.location.href = 'workerManage.aspx';
                }
            });
            /**编辑   **/
            $("a.edit").fancybox({
                ...
                <div class="ui_tb">
                    <asp:GridView ID="GridView1" runat="server" CssClass="table" CellPadding="0" CellSpacing="0" AutoGenerateColumns="false" Width="100%" BorderWidth="0">
                        <Columns>
                            ...
                            <asp:HyperLinkField DataNavigateUrlFormatString="~/workerEdit.aspx?code={0}" DataNavigateUrlFields="code" Text="编辑" ControlStyle-CssClass="edit" />
                            <asp:HyperLinkField DataNavigateUrlFormatString="~/workerManage.aspx?code={0}" DataNavigateUrlFields="code" Text="删除"  />
                        </Columns>
                    </asp:GridView>
